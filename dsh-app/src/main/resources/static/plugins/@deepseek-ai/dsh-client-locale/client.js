window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:/opt/dsh/dsh-java/frontend/packages/client/locale/src/client/LanguageRow.module.css.mjs
		const css = ".TqQeQa_row{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:center;gap:8px;padding:16px 0;display:flex}.TqQeQa_rowText{flex-direction:column;flex:1;gap:4px;min-width:0;padding-right:48px;display:flex}.TqQeQa_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}.TqQeQa_selector{background:var(--dsw-alias-bg-module-platform);height:36px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:18px;align-items:center;gap:12px;padding:0 14px;font-size:14px;line-height:22px;display:inline-flex}.TqQeQa_selector:hover{background:var(--dsw-alias-interactive-bg-hover)}.TqQeQa_chevron{flex:none}";
		...
		var LanguageRow_module_css_default = {
			"chevron": "TqQeQa_chevron",
			"row": "TqQeQa_row",
			"rowText": "TqQeQa_rowText",
			"selector": "TqQeQa_selector",
			"title": "TqQeQa_title"
		};
		//#endregion
