window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/Users/jack/java/dsh-java/frontend/packages/client/ui-workflow-run/src/client/WorkflowRunPanel.module.css.mjs
		const css = ".C3yMNG_root{width:100%;min-width:0}.C3yMNG_runHeader{box-sizing:border-box;background:var(--dsw-alias-bg-module-platform);border-radius:8px;align-items:center;gap:6px;width:100%;min-width:0;height:32px;padding:0 8px;display:flex}.C3yMNG_runHeader:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-2px}.C3yMNG_runLeading{width:calc(16px + var(--dsh-content-font-delta,0px));height:calc(16px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:0;display:inline-flex}.C3yMNG_runTitle{max-width:42%;color:var(--dsw-alias-label-secondary);font-size:var(--dsh-content-font-size-secondary,13px);font-weight:510;line-height:calc(24px + var(--dsh-content-font-delta,0px));text-overflow:ellipsis;white-space:nowrap;flex:none;overflow:hidden}.C3yMNG_runSummary{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(18px + var(--dsh-content-font-delta-secondary,0px));text-overflow:ellipsis;white-space:nowrap;flex:1;overflow:hidden}.C3yMNG_statusTail{height:20px;color:var(--dsw-alias-label-secondary);white-space:nowrap;flex:none;align-items:center;gap:4px;font-size:11px;font-weight:510;line-height:16px;display:inline-flex;overflow:hidden}.C3yMNG_phaseHeader{box-sizing:border-box;align-items:center;gap:6px;width:100%;min-width:0;height:32px;display:flex}.C3yMNG_phaseHeader:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-2px;border-radius:4px}.C3yMNG_phaseLeading{width:calc(16px + var(--dsh-content-font-delta,0px));height:calc(16px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:0;display:inline-flex}.C3yMNG_phaseTitle{min-width:0;max-width:42%;color:var(--dsw-alias-label-secondary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));text-overflow:ellipsis;white-space:nowrap;flex:0 auto;overflow:hidden}.C3yMNG_phaseCount{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px));text-overflow:ellipsis;white-space:nowrap;flex:1;overflow:hidden}.C3yMNG_phaseStatus{width:calc(132px + var(--dsh-content-font-delta-secondary,0px) * 10);color:var(--dsw-alias-label-secondary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px));text-align:right;text-overflow:ellipsis;white-space:nowrap;flex:none;overflow:hidden}.C3yMNG_separator{background:var(--dsw-alias-label-tertiary);border-radius:50%;flex:none;width:2px;height:2px}.C3yMNG_phaseList{flex-direction:column;gap:4px;min-width:0;padding:4px 0 0 16px;display:flex}.C3yMNG_phase{min-width:0}.C3yMNG_members{flex-direction:column;gap:2px;min-width:0;padding:0 0 0 16px;display:flex}.C3yMNG_memberRow,.C3yMNG_memberButton{width:100%;min-width:0;min-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-secondary);font:inherit;text-align:left;background:0 0;border:0;border-radius:4px;align-items:center;gap:12px;padding:0;display:flex}.C3yMNG_memberButton{cursor:pointer}.C3yMNG_memberButton .C3yMNG_memberLabel{color:var(--dsw-alias-state-business-primary);text-underline-position:from-font;text-decoration:underline}.C3yMNG_dotSlot{width:16px;height:calc(24px + var(--dsh-content-font-delta,0px));flex:none;justify-content:center;align-items:center;display:inline-flex;overflow:hidden}.C3yMNG_memberButton:focus-visible{outline:none}.C3yMNG_memberButton:focus-visible .C3yMNG_memberLabelWrap{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.C3yMNG_memberLabelWrap{min-width:0;height:calc(24px + var(--dsh-content-font-delta,0px));border-radius:4px;flex:1;align-items:center;padding:0 2px;display:flex;overflow:hidden}.C3yMNG_memberLabel{min-width:0;color:var(--dsw-alias-label-secondary);font-size:var(--dsh-content-font-size,14px);line-height:calc(24px + var(--dsh-content-font-delta,0px));text-overflow:ellipsis;white-space:nowrap;flex:1;overflow:hidden}.C3yMNG_memberStatus{width:64px;color:var(--dsw-alias-label-secondary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px));text-align:right;text-overflow:ellipsis;white-space:nowrap;flex:none;overflow:hidden}.C3yMNG_empty{color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px));padding:0}@media (width<=560px){.C3yMNG_phaseList,.C3yMNG_members{padding-left:12px}}";
		...
		var WorkflowRunPanel_module_css_default = {
			"dotSlot": "C3yMNG_dotSlot",
			"empty": "C3yMNG_empty",
			"memberButton": "C3yMNG_memberButton",
			"memberLabel": "C3yMNG_memberLabel",
			"memberLabelWrap": "C3yMNG_memberLabelWrap",
			"memberRow": "C3yMNG_memberRow",
			"memberStatus": "C3yMNG_memberStatus",
			"members": "C3yMNG_members",
			"phase": "C3yMNG_phase",
			"phaseCount": "C3yMNG_phaseCount",
			"phaseHeader": "C3yMNG_phaseHeader",
			"phaseLeading": "C3yMNG_phaseLeading",
			"phaseList": "C3yMNG_phaseList",
			"phaseStatus": "C3yMNG_phaseStatus",
			"phaseTitle": "C3yMNG_phaseTitle",
			"root": "C3yMNG_root",
			"runHeader": "C3yMNG_runHeader",
			"runLeading": "C3yMNG_runLeading",
			"runSummary": "C3yMNG_runSummary",
			"runTitle": "C3yMNG_runTitle",
			"separator": "C3yMNG_separator",
			"statusTail": "C3yMNG_statusTail"
		};
		//#endregion
