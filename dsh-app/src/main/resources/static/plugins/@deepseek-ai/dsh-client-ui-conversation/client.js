window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/jack/java/dsh-java/frontend/packages/client/ui-conversation/src/client/input/editor/ReferenceChip.module.css.mjs
		const css$9 = ".Q7dJba_chip{vertical-align:bottom;background:var(--dsw-alias-interactive-bg-hover);max-width:240px;height:22px;color:var(--dsw-alias-state-business-primary);user-select:none;cursor:default;border-radius:6px;align-items:center;gap:3px;padding:0 6px;line-height:22px;display:inline-flex}.Q7dJba_marker{flex:none;font-weight:500}.Q7dJba_icon{flex:none}.Q7dJba_label{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.Q7dJba_invalid{color:var(--dsw-alias-state-error-primary);opacity:.7;text-decoration:line-through}";
		...
		var ReferenceChip_module_css_default = {
			"chip": "Q7dJba_chip",
			"icon": "Q7dJba_icon",
			"invalid": "Q7dJba_invalid",
			"label": "Q7dJba_label",
			"marker": "Q7dJba_marker"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/jack/java/dsh-java/frontend/packages/client/ui-conversation/src/client/input/editor/composer-editor.module.css.mjs
		const css$8 = "._2aXlWG_textRef{color:var(--dsw-alias-state-business-primary);-webkit-box-decoration-break:clone;box-decoration-break:clone}";
		...
		var composer_editor_module_css_default = { "textRef": "_2aXlWG_textRef" };
		//#endregion
 ...
 /* v8 ignore next 4 -- plain-text composition nests no block elements today; the walk stays total for imported states. */
		...
		*/
		...
		var ConversationRoot_module_css_default = {
			...
			"widthHandle": "Zbtjjq_widthHandle"
		};
		//#endregion
