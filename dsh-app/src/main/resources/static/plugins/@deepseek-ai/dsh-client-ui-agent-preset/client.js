window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/jack/java/dsh-java/frontend/packages/client/ui-agent-preset/src/client/AgentPresetLabel.module.css.mjs
		const css$3 = ".BS7i1G_label{background:var(--dsw-alias-fill-tsp-secondary);max-width:180px;height:22px;color:var(--dsw-alias-label-secondary);white-space:nowrap;text-overflow:ellipsis;border-radius:6px;align-items:center;gap:4px;padding:0 2px 0 0;font-size:12px;line-height:22px;display:inline-flex;overflow:hidden}.BS7i1G_icon{opacity:.7;flex:none}";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/jack/java/dsh-java/frontend/packages/client/ui-agent-preset/src/client/AgentPresetRow.module.css.mjs
		const css$2 = ".jGW0-a_row{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:center;gap:8px;padding:16px 0;display:flex}.jGW0-a_rowText{flex-direction:column;flex:1;gap:4px;min-width:0;padding-right:48px;display:flex}.jGW0-a_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}.jGW0-a_desc{color:var(--dsw-alias-label-tertiary);font-size:12px;font-weight:400;line-height:18px}.jGW0-a_selector{background:var(--dsw-alias-bg-module-platform);height:36px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:18px;align-items:center;gap:12px;padding:0 14px;font-size:14px;line-height:22px;display:inline-flex}.jGW0-a_selector:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.jGW0-a_selector:disabled{cursor:default}.jGW0-a_chevron{flex:none}";
		...
		var AgentPresetRow_module_css_default = {
			"chevron": "jGW0-a_chevron",
			"desc": "jGW0-a_desc",
			"row": "jGW0-a_row",
			"rowText": "jGW0-a_rowText",
			"selector": "jGW0-a_selector",
			"title": "jGW0-a_title"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/jack/java/dsh-java/frontend/packages/client/ui-agent-preset/src/client/AgentPresetSeat.module.css.mjs
		const css$1 = ".Gi7h2W_seat{max-width:min(100%,240px);min-height:28px;color:var(--dsw-alias-label-primary);white-space:nowrap;text-overflow:ellipsis;cursor:pointer;background:0 0;border:none;border-radius:16px;align-items:center;gap:4px;padding:0 8px;font-size:13px;font-weight:500;line-height:20px;display:inline-flex;overflow:hidden}.Gi7h2W_seat:not(:disabled):hover,.Gi7h2W_seat[aria-expanded=true]{background:var(--dsw-alias-interactive-bg-hover)}.Gi7h2W_seat:disabled{cursor:default;color:var(--dsw-alias-label-quaternary)}.Gi7h2W_seatIcon{color:var(--dsw-alias-label-primary);flex:none}.Gi7h2W_introIcon{animation:.15s cubic-bezier(.16,1,.3,1) both Gi7h2W_seat-icon-in}@keyframes Gi7h2W_seat-icon-in{0%{opacity:0;transform:scale(.5)}to{opacity:1;transform:scale(1)}}.Gi7h2W_introText{white-space:pre;display:inline-block}.Gi7h2W_introChar{white-space:pre;opacity:0;animation:.4s ease-out forwards Gi7h2W_seat-char-in;display:inline-block}@keyframes Gi7h2W_seat-char-in{0%{opacity:0;transform:translateY(4px)}to{opacity:1;transform:none}}@media (prefers-reduced-motion:reduce){.Gi7h2W_introIcon,.Gi7h2W_introChar{opacity:1;animation:none}}.Gi7h2W_chevron{color:var(--dsw-alias-label-caption);flex:none}.Gi7h2W_item{flex-direction:column;gap:2px;max-width:280px;display:flex}.Gi7h2W_itemName{color:var(--dsw-alias-label-primary);font-size:13px;line-height:20px}.Gi7h2W_itemDesc{color:var(--dsw-alias-label-caption);white-space:normal;font-size:12px;line-height:16px}";
		...
		var AgentPresetSeat_module_css_default = {
			"chevron": "Gi7h2W_chevron",
			"introChar": "Gi7h2W_introChar",
			"introIcon": "Gi7h2W_introIcon",
			"introText": "Gi7h2W_introText",
			"item": "Gi7h2W_item",
			"itemDesc": "Gi7h2W_itemDesc",
			"itemName": "Gi7h2W_itemName",
			"seat": "Gi7h2W_seat",
			"seat-char-in": "Gi7h2W_seat-char-in",
			"seat-icon-in": "Gi7h2W_seat-icon-in",
			"seatIcon": "Gi7h2W_seatIcon"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/jack/java/dsh-java/frontend/packages/client/ui-agent-preset/src/client/AgentPresetSection.module.css.mjs
		const css = ".Qm7fEq_section{max-width:720px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:12px;display:flex}.Qm7fEq_title{margin:0;font-size:18px;font-weight:600}.Qm7fEq_intro{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}.Qm7fEq_group{flex-direction:column;gap:10px;display:flex}.Qm7fEq_group+.Qm7fEq_group{margin-top:20px}.Qm7fEq_groupHead{letter-spacing:.06em;text-transform:uppercase;color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;font-weight:600}.Qm7fEq_cards{grid-template-columns:repeat(auto-fill,minmax(268px,1fr));grid-auto-rows:1fr;gap:12px;margin:0;padding:0;list-style:none;display:grid}.Qm7fEq_card{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;flex-direction:column;transition:border-color .16s,background .16s;display:flex}.Qm7fEq_card:hover:not(.Qm7fEq_cardActive){border-color:var(--dsw-alias-label-dimmed)}.Qm7fEq_cardActive{background:var(--dsw-alias-bg-layer-2);border-color:var(--dsw-alias-label-primary)}.Qm7fEq_cardBroken,.Qm7fEq_cardBroken:hover{border-color:var(--dsw-alias-state-error-primary)}.Qm7fEq_brokenBadge{white-space:nowrap;background:var(--dsw-alias-state-error-primary);color:var(--dsw-alias-bg-layer-3);border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.Qm7fEq_brokenTip{z-index:1;background:var(--dsw-alias-label-primary);width:max-content;max-width:100%;color:var(--dsw-alias-bg-layer-3);text-align:left;white-space:pre-line;overflow-wrap:anywhere;opacity:0;pointer-events:none;border-radius:6px;padding:6px 8px;font-size:11px;font-weight:400;line-height:1.5;transition:opacity .12s;position:absolute;top:calc(100% + 6px);left:0}.Qm7fEq_brokenBadge:hover .Qm7fEq_brokenTip,.Qm7fEq_cardMain:focus-visible .Qm7fEq_brokenTip{opacity:1}.Qm7fEq_cardMain[aria-disabled=true]{cursor:default}.Qm7fEq_cardBrokenReason{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}.Qm7fEq_cardMain{appearance:none;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px 12px 0 0;flex-direction:column;flex:1;gap:8px;padding:14px 16px 12px;display:flex}.Qm7fEq_cardMain:disabled{cursor:default}.Qm7fEq_cardMain:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-2px}.Qm7fEq_cardHead{align-items:center;gap:8px;display:flex;position:relative}.Qm7fEq_cardName{font-size:15px;font-weight:600;line-height:1.4}.Qm7fEq_badge,.Qm7fEq_inUse{white-space:nowrap;border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.Qm7fEq_badge{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-tertiary)}.Qm7fEq_inUse{background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3);margin-left:auto}.Qm7fEq_cardDesc{color:var(--dsw-alias-label-secondary);-webkit-line-clamp:4;overflow-wrap:anywhere;-webkit-box-orient:vertical;min-height:42px;font-size:13px;line-height:1.55;display:-webkit-box;overflow:hidden}.Qm7fEq_cardId{font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);color:var(--dsw-alias-label-dimmed);margin-top:auto;font-size:11px}.Qm7fEq_cardFoot{border-top:1px solid var(--dsw-alias-border-l2);justify-content:flex-end;gap:2px;padding:6px 10px;display:flex}.Qm7fEq_iconButton{appearance:none;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:7px;align-items:center;padding:6px;display:inline-flex;position:relative}.Qm7fEq_iconButton:disabled{opacity:.4;cursor:default}.Qm7fEq_iconButton:hover:not(:disabled){background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary)}.Qm7fEq_iconButton:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-1px}.Qm7fEq_iconButton:after{content:attr(data-tip);background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3);white-space:nowrap;opacity:0;pointer-events:none;border-radius:6px;padding:3px 8px;font-size:11px;line-height:17px;transition:opacity .12s;position:absolute;bottom:calc(100% + 6px);left:50%;transform:translate(-50%)}.Qm7fEq_iconButton:hover:after,.Qm7fEq_iconButton:focus-visible:after{opacity:1}.Qm7fEq_iconDanger:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary)}.Qm7fEq_revealedPath{color:var(--dsw-alias-label-tertiary);align-items:baseline;gap:6px;margin:0;padding:6px 16px 10px;font-size:11px;display:flex}.Qm7fEq_revealedPath code{font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);color:var(--dsw-alias-label-secondary);user-select:all;overflow-wrap:anywhere}.Qm7fEq_revealedPathLabel{white-space:nowrap}.Qm7fEq_secondaryButton{color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border:none;border-radius:7px;padding:5px 8px;font-size:12.5px}.Qm7fEq_secondaryButton:hover:not(:disabled){background:var(--dsw-alias-bg-layer-1)}.Qm7fEq_secondaryButton:disabled{opacity:.5;cursor:default}.Qm7fEq_field{flex-direction:column;gap:6px;display:flex}.Qm7fEq_fieldLabel{color:var(--dsw-alias-label-secondary);font-size:12px;font-weight:500}.Qm7fEq_input{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);font:inherit;background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary);border-radius:10px;padding:9px 12px;font-size:13px}.Qm7fEq_input:focus{border-color:var(--dsw-alias-brand-primary);outline:none}.Qm7fEq_input::placeholder{color:var(--dsw-alias-label-dimmed)}.Qm7fEq_dialog{width:min(560px,100%)}.Qm7fEq_dialogFields{flex-direction:column;gap:12px;display:flex}.Qm7fEq_viewerCode{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);max-height:min(52vh,480px);color:var(--dsw-alias-label-secondary);font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);white-space:pre;tab-size:2;--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:10px;margin:0;padding:12px;font-size:12.5px;line-height:1.5;overflow:auto}.Qm7fEq_error{color:var(--dsw-alias-state-error-primary);margin:0;font-size:12px}.Qm7fEq_deleteDialog{width:min(480px,100%)}.Qm7fEq_deleteConfirm:not(:disabled){border-color:var(--dsw-alias-state-error-primary);color:var(--dsw-alias-state-error-primary)}.Qm7fEq_deleteConfirm:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover-danger)}.Qm7fEq_creatorButton{box-sizing:border-box;border:1px dashed var(--dsw-alias-border-l3);height:44px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border-radius:12px;justify-content:center;align-self:stretch;align-items:center;gap:6px;font-size:14px;line-height:22px;display:flex}.Qm7fEq_creatorButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.Qm7fEq_creatorButton:disabled{opacity:.4;cursor:default}";
		...
		var AgentPresetSection_module_css_default = {
			"badge": "Qm7fEq_badge",
			"brokenBadge": "Qm7fEq_brokenBadge",
			"brokenTip": "Qm7fEq_brokenTip",
			"card": "Qm7fEq_card",
			"cardActive": "Qm7fEq_cardActive",
			"cardBroken": "Qm7fEq_cardBroken",
			"cardBrokenReason": "Qm7fEq_cardBrokenReason",
			"cardDesc": "Qm7fEq_cardDesc",
			"cardFoot": "Qm7fEq_cardFoot",
			"cardHead": "Qm7fEq_cardHead",
			"cardId": "Qm7fEq_cardId",
			"cardMain": "Qm7fEq_cardMain",
			"cardName": "Qm7fEq_cardName",
			"cards": "Qm7fEq_cards",
			"creatorButton": "Qm7fEq_creatorButton",
			"deleteConfirm": "Qm7fEq_deleteConfirm",
			"deleteDialog": "Qm7fEq_deleteDialog",
			"dialog": "Qm7fEq_dialog",
			"dialogFields": "Qm7fEq_dialogFields",
			"error": "Qm7fEq_error",
			"field": "Qm7fEq_field",
			"fieldLabel": "Qm7fEq_fieldLabel",
			"group": "Qm7fEq_group",
			"groupHead": "Qm7fEq_groupHead",
			"iconButton": "Qm7fEq_iconButton",
			"iconDanger": "Qm7fEq_iconDanger",
			"inUse": "Qm7fEq_inUse",
			"input": "Qm7fEq_input",
			"intro": "Qm7fEq_intro",
			"revealedPath": "Qm7fEq_revealedPath",
			"revealedPathLabel": "Qm7fEq_revealedPathLabel",
			"secondaryButton": "Qm7fEq_secondaryButton",
			"section": "Qm7fEq_section",
			"title": "Qm7fEq_title",
			"viewerCode": "Qm7fEq_viewerCode"
		};
		//#endregion
