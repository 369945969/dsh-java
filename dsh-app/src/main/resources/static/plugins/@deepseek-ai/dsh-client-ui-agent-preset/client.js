window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/opt/dsh/dsh-java/frontend/packages/client/ui-agent-preset/src/client/AgentPresetLabel.module.css.mjs
		const css$3 = ".xPpRDW_label{background:var(--dsw-alias-fill-tsp-secondary);max-width:180px;height:22px;color:var(--dsw-alias-label-secondary);white-space:nowrap;text-overflow:ellipsis;border-radius:6px;align-items:center;gap:4px;padding:0 2px 0 0;font-size:12px;line-height:22px;display:inline-flex;overflow:hidden}.xPpRDW_icon{opacity:.7;flex:none}";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/opt/dsh/dsh-java/frontend/packages/client/ui-agent-preset/src/client/AgentPresetRow.module.css.mjs
		const css$2 = ".rfL3VG_row{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:center;gap:8px;padding:16px 0;display:flex}.rfL3VG_rowText{flex-direction:column;flex:1;gap:4px;min-width:0;padding-right:48px;display:flex}.rfL3VG_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}.rfL3VG_desc{color:var(--dsw-alias-label-tertiary);font-size:12px;font-weight:400;line-height:18px}.rfL3VG_selector{background:var(--dsw-alias-bg-module-platform);height:36px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:18px;align-items:center;gap:12px;padding:0 14px;font-size:14px;line-height:22px;display:inline-flex}.rfL3VG_selector:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.rfL3VG_selector:disabled{cursor:default}.rfL3VG_chevron{flex:none}";
		...
		var AgentPresetRow_module_css_default = {
			"chevron": "rfL3VG_chevron",
			"desc": "rfL3VG_desc",
			"row": "rfL3VG_row",
			"rowText": "rfL3VG_rowText",
			"selector": "rfL3VG_selector",
			"title": "rfL3VG_title"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/opt/dsh/dsh-java/frontend/packages/client/ui-agent-preset/src/client/AgentPresetSeat.module.css.mjs
		const css$1 = ".lFed8a_seat{max-width:min(100%,240px);min-height:28px;color:var(--dsw-alias-label-primary);white-space:nowrap;text-overflow:ellipsis;cursor:pointer;background:0 0;border:none;border-radius:16px;align-items:center;gap:4px;padding:0 8px;font-size:13px;font-weight:500;line-height:20px;display:inline-flex;overflow:hidden}.lFed8a_seat:not(:disabled):hover,.lFed8a_seat[aria-expanded=true]{background:var(--dsw-alias-interactive-bg-hover)}.lFed8a_seat:disabled{cursor:default;color:var(--dsw-alias-label-quaternary)}.lFed8a_seatIcon{color:var(--dsw-alias-label-primary);flex:none}.lFed8a_introIcon{animation:.15s cubic-bezier(.16,1,.3,1) both lFed8a_seat-icon-in}@keyframes lFed8a_seat-icon-in{0%{opacity:0;transform:scale(.5)}to{opacity:1;transform:scale(1)}}.lFed8a_introText{white-space:pre;display:inline-block}.lFed8a_introChar{white-space:pre;opacity:0;animation:.4s ease-out forwards lFed8a_seat-char-in;display:inline-block}@keyframes lFed8a_seat-char-in{0%{opacity:0;transform:translateY(4px)}to{opacity:1;transform:none}}@media (prefers-reduced-motion:reduce){.lFed8a_introIcon,.lFed8a_introChar{opacity:1;animation:none}}.lFed8a_chevron{color:var(--dsw-alias-label-caption);flex:none}.lFed8a_item{flex-direction:column;gap:2px;max-width:280px;display:flex}.lFed8a_itemName{color:var(--dsw-alias-label-primary);font-size:13px;line-height:20px}.lFed8a_itemDesc{color:var(--dsw-alias-label-caption);white-space:normal;font-size:12px;line-height:16px}";
		...
		var AgentPresetSeat_module_css_default = {
			"chevron": "lFed8a_chevron",
			"introChar": "lFed8a_introChar",
			"introIcon": "lFed8a_introIcon",
			"introText": "lFed8a_introText",
			"item": "lFed8a_item",
			"itemDesc": "lFed8a_itemDesc",
			"itemName": "lFed8a_itemName",
			"seat": "lFed8a_seat",
			"seat-char-in": "lFed8a_seat-char-in",
			"seat-icon-in": "lFed8a_seat-icon-in",
			"seatIcon": "lFed8a_seatIcon"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/opt/dsh/dsh-java/frontend/packages/client/ui-agent-preset/src/client/AgentPresetSection.module.css.mjs
		const css = ".JoIBVW_section{max-width:720px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:12px;display:flex}.JoIBVW_title{margin:0;font-size:18px;font-weight:600}.JoIBVW_intro{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}.JoIBVW_group{flex-direction:column;gap:10px;display:flex}.JoIBVW_group+.JoIBVW_group{margin-top:20px}.JoIBVW_groupHead{letter-spacing:.06em;text-transform:uppercase;color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;font-weight:600}.JoIBVW_cards{grid-template-columns:repeat(auto-fill,minmax(268px,1fr));grid-auto-rows:1fr;gap:12px;margin:0;padding:0;list-style:none;display:grid}.JoIBVW_card{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;flex-direction:column;transition:border-color .16s,background .16s;display:flex}.JoIBVW_card:hover:not(.JoIBVW_cardActive){border-color:var(--dsw-alias-label-dimmed)}.JoIBVW_cardActive{background:var(--dsw-alias-bg-layer-2);border-color:var(--dsw-alias-label-primary)}.JoIBVW_cardBroken,.JoIBVW_cardBroken:hover{border-color:var(--dsw-alias-state-error-primary)}.JoIBVW_brokenBadge{white-space:nowrap;background:var(--dsw-alias-state-error-primary);color:var(--dsw-alias-bg-layer-3);border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.JoIBVW_cardBrokenReason{color:var(--dsw-alias-state-error-primary);overflow-wrap:anywhere;font-size:12px;line-height:1.5}.JoIBVW_cardMain{appearance:none;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px 12px 0 0;flex-direction:column;flex:1;gap:8px;padding:14px 16px 12px;display:flex}.JoIBVW_cardMain:disabled{cursor:default}.JoIBVW_cardMain:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-2px}.JoIBVW_cardHead{align-items:center;gap:8px;display:flex}.JoIBVW_cardName{font-size:15px;font-weight:600;line-height:1.4}.JoIBVW_badge,.JoIBVW_inUse{white-space:nowrap;border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.JoIBVW_badge{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-tertiary)}.JoIBVW_inUse{background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3);margin-left:auto}.JoIBVW_cardDesc{color:var(--dsw-alias-label-secondary);-webkit-line-clamp:4;overflow-wrap:anywhere;-webkit-box-orient:vertical;min-height:42px;font-size:13px;line-height:1.55;display:-webkit-box;overflow:hidden}.JoIBVW_cardId{font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);color:var(--dsw-alias-label-dimmed);margin-top:auto;font-size:11px}.JoIBVW_cardFoot{border-top:1px solid var(--dsw-alias-border-l2);justify-content:flex-end;gap:2px;padding:6px 10px;display:flex}.JoIBVW_iconButton{appearance:none;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:7px;align-items:center;padding:6px;display:inline-flex;position:relative}.JoIBVW_iconButton:disabled{opacity:.4;cursor:default}.JoIBVW_iconButton:hover:not(:disabled){background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary)}.JoIBVW_iconButton:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-1px}.JoIBVW_iconButton:after{content:attr(data-tip);background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3);white-space:nowrap;opacity:0;pointer-events:none;border-radius:6px;padding:3px 8px;font-size:11px;line-height:17px;transition:opacity .12s;position:absolute;bottom:calc(100% + 6px);left:50%;transform:translate(-50%)}.JoIBVW_iconButton:hover:after,.JoIBVW_iconButton:focus-visible:after{opacity:1}.JoIBVW_iconDanger:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary)}.JoIBVW_revealedPath{color:var(--dsw-alias-label-tertiary);align-items:baseline;gap:6px;margin:0;padding:6px 16px 10px;font-size:11px;display:flex}.JoIBVW_revealedPath code{font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);color:var(--dsw-alias-label-secondary);user-select:all;overflow-wrap:anywhere}.JoIBVW_revealedPathLabel{white-space:nowrap}.JoIBVW_secondaryButton{color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border:none;border-radius:7px;padding:5px 8px;font-size:12.5px}.JoIBVW_secondaryButton:hover:not(:disabled){background:var(--dsw-alias-bg-layer-1)}.JoIBVW_secondaryButton:disabled{opacity:.5;cursor:default}.JoIBVW_field{flex-direction:column;gap:6px;display:flex}.JoIBVW_fieldLabel{color:var(--dsw-alias-label-secondary);font-size:12px;font-weight:500}.JoIBVW_input{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);font:inherit;background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary);border-radius:10px;padding:9px 12px;font-size:13px}.JoIBVW_input:focus{border-color:var(--dsw-alias-brand-primary);outline:none}.JoIBVW_input::placeholder{color:var(--dsw-alias-label-dimmed)}.JoIBVW_dialog{width:min(560px,100%)}.JoIBVW_dialogFields{flex-direction:column;gap:12px;display:flex}.JoIBVW_viewerCode{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);max-height:min(52vh,480px);color:var(--dsw-alias-label-secondary);font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);white-space:pre;tab-size:2;--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:10px;margin:0;padding:12px;font-size:12.5px;line-height:1.5;overflow:auto}.JoIBVW_error{color:var(--dsw-alias-state-error-primary);margin:0;font-size:12px}.JoIBVW_deleteDialog{width:min(480px,100%)}.JoIBVW_deleteConfirm:not(:disabled){border-color:var(--dsw-alias-state-error-primary);color:var(--dsw-alias-state-error-primary)}.JoIBVW_deleteConfirm:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover-danger)}.JoIBVW_creatorButton{box-sizing:border-box;border:1px dashed var(--dsw-alias-border-l3);height:44px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border-radius:12px;justify-content:center;align-self:stretch;align-items:center;gap:6px;font-size:14px;line-height:22px;display:flex}.JoIBVW_creatorButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.JoIBVW_creatorButton:disabled{opacity:.4;cursor:default}";
		...
		var AgentPresetSection_module_css_default = {
			"badge": "JoIBVW_badge",
			"brokenBadge": "JoIBVW_brokenBadge",
			"card": "JoIBVW_card",
			"cardActive": "JoIBVW_cardActive",
			"cardBroken": "JoIBVW_cardBroken",
			"cardBrokenReason": "JoIBVW_cardBrokenReason",
			"cardDesc": "JoIBVW_cardDesc",
			"cardFoot": "JoIBVW_cardFoot",
			"cardHead": "JoIBVW_cardHead",
			"cardId": "JoIBVW_cardId",
			"cardMain": "JoIBVW_cardMain",
			"cardName": "JoIBVW_cardName",
			"cards": "JoIBVW_cards",
			"creatorButton": "JoIBVW_creatorButton",
			"deleteConfirm": "JoIBVW_deleteConfirm",
			"deleteDialog": "JoIBVW_deleteDialog",
			"dialog": "JoIBVW_dialog",
			"dialogFields": "JoIBVW_dialogFields",
			"error": "JoIBVW_error",
			"field": "JoIBVW_field",
			"fieldLabel": "JoIBVW_fieldLabel",
			"group": "JoIBVW_group",
			"groupHead": "JoIBVW_groupHead",
			"iconButton": "JoIBVW_iconButton",
			"iconDanger": "JoIBVW_iconDanger",
			"inUse": "JoIBVW_inUse",
			"input": "JoIBVW_input",
			"intro": "JoIBVW_intro",
			"revealedPath": "JoIBVW_revealedPath",
			"revealedPathLabel": "JoIBVW_revealedPathLabel",
			"secondaryButton": "JoIBVW_secondaryButton",
			"section": "JoIBVW_section",
			"title": "JoIBVW_title",
			"viewerCode": "JoIBVW_viewerCode"
		};
		//#endregion
