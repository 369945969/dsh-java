window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/jack/java/dsh-java/frontend/packages/client/ui-chat/src/client/chat/MessageItem.module.css.mjs
		const css$15 = ".dpuYAG_userRow{flex-direction:column;align-items:flex-end;gap:6px;display:flex}.dpuYAG_userStack{min-width:0;max-width:min(calc(var(--dsh-chat-content-width,748px) * .702), 82%);flex-direction:column;align-items:flex-end;gap:8px;display:flex}.dpuYAG_bubble{background:var(--dsw-specific-bubble);max-width:100%;font-size:var(--dsh-content-font-size,14px);line-height:calc(22px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-primary);white-space:pre-wrap;word-break:break-word;border-radius:22px;padding:10px 16px}.dpuYAG_referenceSummary{color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(18px + var(--dsh-content-font-delta-secondary,0px))}.dpuYAG_contextRow,.dpuYAG_compactionRow{padding:2px 0}.dpuYAG_compactionButton{width:100%;height:calc(24px + var(--dsh-content-font-delta,0px));min-width:0;color:inherit;font:inherit;text-align:left;background:0 0;border:none;border-radius:6px;align-items:center;padding:0;display:flex}.dpuYAG_compactionButton:not(:disabled){cursor:pointer}.dpuYAG_compactionButton:not(:disabled):hover{background:var(--dsw-alias-interactive-bg-hover)}.dpuYAG_compactionLeading{width:calc(16px + var(--dsh-content-font-delta,0px));height:calc(16px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-secondary);flex:none;place-items:center;margin-right:6px;display:inline-grid}.dpuYAG_compactionLeading svg{width:calc(14px + var(--dsh-content-font-delta,0px));height:calc(14px + var(--dsh-content-font-delta,0px))}.dpuYAG_compactionContextIcon,.dpuYAG_compactionDisclosureIcon{grid-area:1/1;justify-content:center;align-items:center;display:inline-flex}.dpuYAG_compactionDisclosureIcon,.dpuYAG_compactionButton:not(:disabled):hover .dpuYAG_compactionContextIcon,.dpuYAG_compactionButton:not(:disabled):focus-visible .dpuYAG_compactionContextIcon{opacity:0}.dpuYAG_compactionButton:not(:disabled):hover .dpuYAG_compactionDisclosureIcon,.dpuYAG_compactionButton:not(:disabled):focus-visible .dpuYAG_compactionDisclosureIcon{opacity:1}.dpuYAG_compactionTitle{font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-primary-dimmed);flex:none}.dpuYAG_compactionSep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.dpuYAG_compactionSummary{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));text-overflow:ellipsis;white-space:nowrap;flex:auto;overflow:hidden}.dpuYAG_compactionBody{padding:4px 0 4px calc(22px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px))}.dpuYAG_retryRow{color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px))}.dpuYAG_retrySummary{width:fit-content;color:inherit;cursor:pointer;user-select:none;border-radius:3px;align-items:center;gap:7px;padding:2px 0;list-style:none;display:inline-flex}.dpuYAG_retrySummary::-webkit-details-marker{display:none}.dpuYAG_retrySummary:after{content:\"\";opacity:.8;border-bottom:1.5px solid;border-right:1.5px solid;width:6px;height:6px;transition:transform .12s;transform:rotate(-45deg)}.dpuYAG_retrySummary:hover{color:var(--dsw-alias-label-secondary)}.dpuYAG_retrySummary:focus-visible{outline:1.5px solid var(--dsw-alias-button-info-fill);outline-offset:2px}.dpuYAG_retryText{color:inherit}.dpuYAG_retryRow[data-active] .dpuYAG_retryText{background:linear-gradient(90deg, var(--dsw-alias-label-tertiary) 0%, var(--dsw-alias-label-tertiary) 40%, var(--dsw-alias-label-secondary) 50%, var(--dsw-alias-label-tertiary) 60%, var(--dsw-alias-label-tertiary) 100%);color:#0000;background-position:100%;background-size:200% 100%;background-clip:text;animation:1.6s ease-in-out infinite dpuYAG_retry-shimmer}.dpuYAG_retryRow[open] .dpuYAG_retrySummary:after{transform:rotate(45deg)}.dpuYAG_retryDetails{overflow-wrap:anywhere;font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(18px + var(--dsh-content-font-delta-secondary,0px));gap:2px;margin-top:3px;padding-left:14px;display:grid}.dpuYAG_retryDetailLabel{color:var(--dsw-alias-label-secondary)}.dpuYAG_turnErrorRow{font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px));grid-template-columns:10px minmax(0,1fr) auto;align-items:start;gap:8px;padding:2px 0;display:grid}.dpuYAG_turnErrorDot{margin-top:5px}.dpuYAG_turnErrorCopy{overflow-wrap:anywhere;min-width:0}.dpuYAG_turnErrorTitle{color:var(--dsw-alias-state-error-primary);margin-right:6px;font-weight:600}.dpuYAG_turnErrorMessage{color:var(--dsw-alias-label-secondary)}.dpuYAG_turnErrorCode{color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-markdown-code-block-small)}.dpuYAG_maxTokensTitle{color:var(--dsw-alias-state-warn-primary);margin-right:6px;font-weight:600}@keyframes dpuYAG_retry-shimmer{0%{background-position:100%}to{background-position:0}}@media (prefers-reduced-motion:reduce){.dpuYAG_retryRow[data-active] .dpuYAG_retryText{color:inherit;background:0 0;animation:none}}";
		...
		var MessageItem_module_css_default = {
			"bubble": "dpuYAG_bubble",
			"compactionBody": "dpuYAG_compactionBody",
			"compactionButton": "dpuYAG_compactionButton",
			"compactionContextIcon": "dpuYAG_compactionContextIcon",
			"compactionDisclosureIcon": "dpuYAG_compactionDisclosureIcon",
			"compactionLeading": "dpuYAG_compactionLeading",
			"compactionRow": "dpuYAG_compactionRow",
			"compactionSep": "dpuYAG_compactionSep",
			"compactionSummary": "dpuYAG_compactionSummary",
			"compactionTitle": "dpuYAG_compactionTitle",
			"contextRow": "dpuYAG_contextRow",
			"maxTokensTitle": "dpuYAG_maxTokensTitle",
			"referenceSummary": "dpuYAG_referenceSummary",
			"retry-shimmer": "dpuYAG_retry-shimmer",
			"retryDetailLabel": "dpuYAG_retryDetailLabel",
			"retryDetails": "dpuYAG_retryDetails",
			"retryRow": "dpuYAG_retryRow",
			"retrySummary": "dpuYAG_retrySummary",
			"retryText": "dpuYAG_retryText",
			"turnErrorCode": "dpuYAG_turnErrorCode",
			"turnErrorCopy": "dpuYAG_turnErrorCopy",
			"turnErrorDot": "dpuYAG_turnErrorDot",
			"turnErrorMessage": "dpuYAG_turnErrorMessage",
			"turnErrorRow": "dpuYAG_turnErrorRow",
			"turnErrorTitle": "dpuYAG_turnErrorTitle",
			"userRow": "dpuYAG_userRow",
			"userStack": "dpuYAG_userStack"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/jack/java/dsh-java/frontend/packages/client/ui-chat/src/client/chat/ContextBody.module.css.mjs
		const css$14 = ".keLloW_text{color:var(--dsw-alias-label-secondary);font:inherit;white-space:pre-wrap;overflow-wrap:anywhere;margin:0}.keLloW_fields{border-top:1px solid var(--dsw-alias-line-secondary);flex-direction:column;gap:2px;margin:8px 0 0;padding-top:8px;display:flex}.keLloW_field{gap:8px;min-width:0;display:flex}.keLloW_fieldKey{min-width:96px;color:var(--dsw-alias-label-caption);flex:none}.keLloW_fieldValue{min-width:0;color:var(--dsw-alias-label-tertiary);overflow-wrap:anywhere;flex:auto;margin:0}.keLloW_files{flex-wrap:wrap;gap:4px 12px;margin:0 0 8px;padding:0;list-style:none;display:flex}.keLloW_file{align-items:baseline;gap:6px;min-width:0;display:flex}.keLloW_filePath{color:var(--dsw-alias-label-secondary);overflow-wrap:anywhere}.keLloW_fileAction{color:var(--dsw-alias-label-caption)}.keLloW_catalogNotice{color:var(--dsw-alias-label-caption);margin:0 0 6px}.keLloW_entries{flex-direction:column;gap:4px;margin:0;padding:0;list-style:none;display:flex}.keLloW_entry{gap:8px;min-width:0;display:flex}.keLloW_entryName{color:var(--dsw-alias-label-secondary);flex:none}.keLloW_entryDescription{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;flex:auto;overflow:hidden}.keLloW_sections{flex-direction:column;gap:8px;margin:0;display:flex}.keLloW_section{flex-direction:column;gap:2px;min-width:0;display:flex}.keLloW_sectionName{color:var(--dsw-alias-label-caption)}.keLloW_sectionText{color:var(--dsw-alias-label-secondary);white-space:pre-wrap;overflow-wrap:anywhere;margin:0}.keLloW_relaySender{color:var(--dsw-alias-label-caption);overflow-wrap:anywhere;margin:0 0 6px}.keLloW_recalls{flex-direction:column;gap:2px;margin:0 0 8px;padding:0;list-style:none;display:flex}.keLloW_recall{gap:8px;min-width:0;display:flex}.keLloW_recallLabel{color:var(--dsw-alias-label-secondary);overflow-wrap:anywhere}.keLloW_recallCounts{color:var(--dsw-alias-label-caption);flex:none}";
		...
		var ContextBody_module_css_default = {
			"catalogNotice": "keLloW_catalogNotice",
			"entries": "keLloW_entries",
			"entry": "keLloW_entry",
			"entryDescription": "keLloW_entryDescription",
			"entryName": "keLloW_entryName",
			"field": "keLloW_field",
			"fieldKey": "keLloW_fieldKey",
			"fieldValue": "keLloW_fieldValue",
			"fields": "keLloW_fields",
			"file": "keLloW_file",
			"fileAction": "keLloW_fileAction",
			"filePath": "keLloW_filePath",
			"files": "keLloW_files",
			"recall": "keLloW_recall",
			"recallCounts": "keLloW_recallCounts",
			"recallLabel": "keLloW_recallLabel",
			"recalls": "keLloW_recalls",
			"relaySender": "keLloW_relaySender",
			"section": "keLloW_section",
			"sectionName": "keLloW_sectionName",
			"sectionText": "keLloW_sectionText",
			"sections": "keLloW_sections",
			"text": "keLloW_text"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/jack/java/dsh-java/frontend/packages/client/ui-chat/src/client/chat/ContextInjectionRow.module.css.mjs
		const css$13 = ".Mq_T0a_root{min-width:0}.Mq_T0a_root[data-open]{padding-bottom:4px}.Mq_T0a_chevron{color:var(--dsw-alias-label-secondary)}.Mq_T0a_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.Mq_T0a_source{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));text-overflow:ellipsis;white-space:nowrap;flex:none;overflow:hidden}.Mq_T0a_summary{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));text-overflow:ellipsis;white-space:nowrap;flex:auto;overflow:hidden}.Mq_T0a_body{box-sizing:border-box;width:calc(100% - 22px - var(--dsh-content-font-delta,0px));max-height:141px;margin:4px 0 0 calc(22px + var(--dsh-content-font-delta,0px));background:var(--dsw-alias-markdown-code-block);color:var(--dsw-alias-label-tertiary);font:400 11px/16px var(--ds-font-family-code);border:none;border-radius:8px;padding:10px 16px 12px 12px;overflow:auto}";
		...
		var ContextInjectionRow_module_css_default = {
			"body": "Mq_T0a_body",
			"chevron": "Mq_T0a_chevron",
			"root": "Mq_T0a_root",
			"sep": "Mq_T0a_sep",
			"source": "Mq_T0a_source",
			"summary": "Mq_T0a_summary"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/jack/java/dsh-java/frontend/packages/client/ui-chat/src/client/chat/MessageIconActions.module.css.mjs
		const css$12 = ".HNwYOG_actions{height:calc(28px + var(--dsh-content-font-delta,0px));align-items:center;gap:10px;display:flex}.HNwYOG_timeStart{font-size:var(--dsh-content-font-size,14px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);white-space:nowrap;padding-right:12px}.HNwYOG_timeEnd{font-size:var(--dsh-content-font-size,14px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);white-space:nowrap;padding-left:12px}.HNwYOG_runTimeDot{margin:0 10px}@media (hover:hover){[data-time-hover-root] :is(.HNwYOG_timeStart,.HNwYOG_timeEnd){opacity:0;transition:opacity 80ms}[data-time-hover-root]:hover :is(.HNwYOG_timeStart,.HNwYOG_timeEnd),[data-time-hover-root]:focus-within :is(.HNwYOG_timeStart,.HNwYOG_timeEnd){opacity:1}}.HNwYOG_action{width:calc(28px + var(--dsh-content-font-delta,0px));height:calc(28px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:28px;justify-content:center;align-items:center;padding:6px;display:inline-flex}.HNwYOG_action svg{width:calc(16px + var(--dsh-content-font-delta,0px));height:calc(16px + var(--dsh-content-font-delta,0px))}.HNwYOG_action:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.HNwYOG_action[data-unavailable]{cursor:default;opacity:.4}.HNwYOG_action[data-unavailable]:hover{color:var(--dsw-alias-label-tertiary);background:0 0}.HNwYOG_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var MessageIconActions_module_css_default = {
			"action": "HNwYOG_action",
			"actions": "HNwYOG_actions",
			"runTimeDot": "HNwYOG_runTimeDot",
			"timeEnd": "HNwYOG_timeEnd",
			"timeStart": "HNwYOG_timeStart",
			"visuallyHidden": "HNwYOG_visuallyHidden"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/jack/java/dsh-java/frontend/packages/client/ui-chat/src/client/chat/ChatView.module.css.mjs
		const css$11 = "._9bAOIq_root{flex-direction:column;flex:auto;min-height:0;display:flex;position:relative}._9bAOIq_scroll{min-height:0;padding:16px calc(var(--dsh-composer-side-clearance) + 16px);flex:auto;overflow-y:auto;container-type:inline-size}[data-conversation-scroll] ._9bAOIq_root{flex:none;height:auto;min-height:auto}[data-conversation-scroll] ._9bAOIq_scroll{flex:none;min-height:auto;overflow:visible}._9bAOIq_column{max-width:var(--dsh-chat-content-width);flex-direction:column;width:100%;margin:0 auto;display:flex}._9bAOIq_column>:not([hidden]):not(._9bAOIq_flowItem:empty)~:not([hidden]):not(._9bAOIq_flowItem:empty){margin-top:var(--dsh-chat-flow-gap,16px)}._9bAOIq_flowItem{min-width:0}._9bAOIq_flowItem[data-turn-process-answer]{--dsh-chat-flow-gap:8px}._9bAOIq_flowItem:empty{display:none}._9bAOIq_callRow{border-radius:6px}._9bAOIq_turnStatus{height:calc(26px + var(--dsh-content-font-delta,0px));font:var(--dsw-font-s-strong-14);font-size:var(--dsh-content-font-size,14px);line-height:calc(22px + var(--dsh-content-font-delta,0px));white-space:nowrap;background:linear-gradient(90deg, var(--dsw-static-deepseek-500) 0%, var(--dsw-static-deepseek-500) 40%, var(--dsw-static-deepseek-200) 50%, var(--dsw-static-deepseek-500) 60%, var(--dsw-static-deepseek-500) 100%);color:#0000;-webkit-text-fill-color:transparent;background-position:100% 0;background-size:250% 100%;-webkit-background-clip:text;background-clip:text;flex:none;align-self:flex-start;align-items:center;animation:1.8s linear infinite _9bAOIq_dsh-turn-status-shimmer;display:inline-flex}._9bAOIq_turnStatusClock{font:var(--dsw-font-xs-13);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px));font-variant-numeric:tabular-nums;color:var(--dsw-alias-label-caption);-webkit-text-fill-color:var(--dsw-alias-label-caption);margin-left:8px;font-weight:400}@keyframes _9bAOIq_dsh-turn-status-shimmer{to{background-position:0 0}}@media (prefers-reduced-motion:reduce){._9bAOIq_turnStatus{background-position:0 0;background-size:100% 100%;animation:none}}._9bAOIq_hint{color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(18px + var(--dsh-content-font-delta-secondary,0px))}._9bAOIq_openError{color:var(--dsw-alias-state-error-primary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(18px + var(--dsh-content-font-delta-secondary,0px))}._9bAOIq_older{justify-content:center;display:flex}._9bAOIq_older button{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-interactive-bg-hover-solid);cursor:pointer;border:none;border-radius:14px;padding:4px 12px;font-size:12px}._9bAOIq_older button:disabled{cursor:default;opacity:.6}._9bAOIq_toBottomSlot{z-index:8;height:0;padding-right:max(0px, calc((100% - var(--dsh-chat-content-width)) / 2));pointer-events:none;justify-content:flex-end;display:flex;position:sticky;bottom:16px}[data-conversation-scroll] ._9bAOIq_toBottomSlot{bottom:calc(var(--dsh-composer-height,152px) + 16px)}._9bAOIq_toBottom{border:1px solid var(--dsw-alias-border-l2);width:34px;height:34px;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-button-floating-fill);box-shadow:var(--dsw-shadow-lv2);cursor:pointer;pointer-events:auto;border-radius:100px;justify-content:center;align-items:center;margin-top:-34px;padding:0;display:flex}._9bAOIq_toBottom:hover{background:var(--dsw-alias-button-floating-hover)}._9bAOIq_modalAction{min-width:72px}";
		...
		var ChatView_module_css_default = {
			"callRow": "_9bAOIq_callRow",
			"column": "_9bAOIq_column",
			"dsh-turn-status-shimmer": "_9bAOIq_dsh-turn-status-shimmer",
			"flowItem": "_9bAOIq_flowItem",
			"hint": "_9bAOIq_hint",
			"modalAction": "_9bAOIq_modalAction",
			"older": "_9bAOIq_older",
			"openError": "_9bAOIq_openError",
			"root": "_9bAOIq_root",
			"scroll": "_9bAOIq_scroll",
			"toBottom": "_9bAOIq_toBottom",
			"toBottomSlot": "_9bAOIq_toBottomSlot",
			"turnStatus": "_9bAOIq_turnStatus",
			"turnStatusClock": "_9bAOIq_turnStatusClock"
		};
		//#endregion
		...
		//#endregion
		//#region \0dsh-css:/Users/jack/java/dsh-java/frontend/packages/client/ui-chat/src/client/chat/TurnNavigator.module.css.mjs
		const css$10 = "._5Vp8Kq_slot{z-index:6;pointer-events:none;height:0;position:sticky;top:0}._5Vp8Kq_rail{--turn-rail-band:calc(var(--dsh-conversation-viewport-height,100dvh) - var(--dsh-composer-height,152px));--turn-preview-height:100px;top:calc(var(--turn-rail-band) / 2);right:calc(12px - (var(--dsh-composer-side-clearance) + 16px));width:28px;height:min(var(--turn-natural-height), max(0px, calc(var(--turn-rail-band) - 64px)), 420px);cursor:pointer;pointer-events:auto;transition:height .22s cubic-bezier(.2,.8,.2,1);position:absolute;transform:translateY(-50%)}._5Vp8Kq_marks{inset:var(--turn-rail-inset) 0;position:absolute}._5Vp8Kq_markPosition{top:min(var(--turn-natural-position), var(--turn-position));height:10px;transition:top .22s cubic-bezier(.2,.8,.2,1);animation:.15s ease-out _5Vp8Kq_dsh-turn-mark-enter;position:absolute;left:0;right:0;transform:translateY(-50%)}._5Vp8Kq_mark{cursor:pointer;pointer-events:none;background:0 0;border:0;border-radius:8px;width:20px;padding:0;position:absolute;inset:0 0 0 auto}._5Vp8Kq_mark:before{background:var(--dsw-alias-border-l4);content:\"\";border-radius:2px;width:12px;height:2px;transition:width .14s,background-color .14s;position:absolute;top:50%;right:0;transform:translateY(-50%)}._5Vp8Kq_markPreview:before{background:var(--dsw-alias-label-tertiary);width:18px}._5Vp8Kq_markActive:before{background:var(--dsw-alias-label-primary);width:20px}._5Vp8Kq_mark:focus-visible:before{background:var(--dsw-alias-state-business-primary);width:20px}._5Vp8Kq_mark:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}._5Vp8Kq_preview{top:clamp(0px, calc(min(var(--turn-natural-position), var(--turn-position)) + var(--turn-rail-inset) - var(--turn-preview-height) / 2), calc(100% - var(--turn-preview-height)));box-sizing:border-box;width:min(300px,100cqw - 120px);max-height:var(--turn-preview-height);border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);box-shadow:var(--dsw-shadow-lv2);pointer-events:none;border-radius:10px;padding:10px 12px;transition:top .14s cubic-bezier(.2,.8,.2,1);animation:.12s ease-out _5Vp8Kq_dsh-turn-preview-enter;position:absolute;right:calc(100% + 10px);overflow:hidden}._5Vp8Kq_previewPrompt,._5Vp8Kq_previewResponse{-webkit-box-orient:vertical;display:-webkit-box;overflow:hidden}._5Vp8Kq_previewPrompt{font:var(--dsw-font-xs-strong-13);-webkit-line-clamp:2}._5Vp8Kq_previewResponse{color:var(--dsw-alias-label-caption);font:var(--dsw-font-xxs-12);-webkit-line-clamp:2;margin-top:4px}@keyframes _5Vp8Kq_dsh-turn-mark-enter{0%{opacity:0}to{opacity:1}}@keyframes _5Vp8Kq_dsh-turn-preview-enter{0%{opacity:0;transform:translate(4px)}to{opacity:1;transform:translate(0)}}@container (width<=900px){._5Vp8Kq_slot{display:none}}@media (prefers-reduced-motion:reduce){._5Vp8Kq_rail,._5Vp8Kq_markPosition,._5Vp8Kq_mark:before,._5Vp8Kq_preview{transition:none;animation:none}}";
		...
		var TurnNavigator_module_css_default = {
			"dsh-turn-mark-enter": "_5Vp8Kq_dsh-turn-mark-enter",
			"dsh-turn-preview-enter": "_5Vp8Kq_dsh-turn-preview-enter",
			"mark": "_5Vp8Kq_mark",
			"markActive": "_5Vp8Kq_markActive",
			"markPosition": "_5Vp8Kq_markPosition",
			"markPreview": "_5Vp8Kq_markPreview",
			"marks": "_5Vp8Kq_marks",
			"preview": "_5Vp8Kq_preview",
			"previewPrompt": "_5Vp8Kq_previewPrompt",
			"previewResponse": "_5Vp8Kq_previewResponse",
			"rail": "_5Vp8Kq_rail",
			"slot": "_5Vp8Kq_slot"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/jack/java/dsh-java/frontend/packages/client/ui-chat/src/client/chat/accessibility.module.css.mjs
		const css$9 = ".YNE9Ra_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var accessibility_module_css_default = { "visuallyHidden": "YNE9Ra_visuallyHidden" };
		//#endregion
		//#region \0dsh-css:/Users/jack/java/dsh-java/frontend/packages/client/ui-chat/src/client/chat/ReasoningRow.module.css.mjs
		const css$8 = ".FEPhkW_root{flex-direction:column;display:flex}.FEPhkW_row{position:relative;overflow:hidden}.FEPhkW_root[data-state=running] .FEPhkW_row:after{content:\"\";inset-block:0;background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite FEPhkW_dsh-reasoning-row-sweep;position:absolute;left:0}@keyframes FEPhkW_dsh-reasoning-row-sweep{0%{left:-300px}90%,to{left:100%}}.FEPhkW_leading{flex-shrink:0}.FEPhkW_chevron{color:var(--dsw-alias-label-secondary)}.FEPhkW_title{font-weight:400}.FEPhkW_separator{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.FEPhkW_summary{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px));text-overflow:ellipsis;white-space:nowrap;flex:auto;overflow:hidden}.FEPhkW_summary[data-follow-end]{text-overflow:clip}.FEPhkW_thinkBody{padding:4px 0 4px calc(22px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px));white-space:pre-wrap;word-break:break-word}@media (prefers-reduced-motion:reduce){.FEPhkW_root[data-state=running] .FEPhkW_row:after{animation:none}}";
		...
		var ReasoningRow_module_css_default = {
			"chevron": "FEPhkW_chevron",
			"dsh-reasoning-row-sweep": "FEPhkW_dsh-reasoning-row-sweep",
			"leading": "FEPhkW_leading",
			"root": "FEPhkW_root",
			"row": "FEPhkW_row",
			"separator": "FEPhkW_separator",
			"summary": "FEPhkW_summary",
			"thinkBody": "FEPhkW_thinkBody",
			"title": "FEPhkW_title"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/jack/java/dsh-java/frontend/packages/client/ui-chat/src/client/chat/AssistantMarkdown.module.css.mjs
		const css$7 = ".dLyUsa_root{font-size:var(--dsh-content-font-size,14px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-primary);flex-direction:column;display:flex}.dLyUsa_body{flex-direction:column;gap:16px;display:flex}.dLyUsa_body .md-table-wide{--dsh-table-spare:max(0px, calc((100cqw - var(--dsh-chat-content-width)) / 2));--dsh-table-lead:calc(var(--dsh-table-spare) + min(var(--dsh-chat-content-width), 100cqw) - 100%);box-sizing:border-box;width:calc(100% + var(--dsh-table-lead) + var(--dsh-table-spare));max-width:none;margin-left:calc(-1 * var(--dsh-table-lead));padding-left:var(--dsh-table-lead)}.dLyUsa_body>[data-turn-process-inline][hidden]{margin-bottom:-16px}.dLyUsa_stopped{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-tertiary);border-radius:6px;align-self:flex-start;padding:0 6px;font-size:11px;line-height:18px}.dLyUsa_actions{margin-top:16px;margin-left:-6px}";
		...
		var AssistantMarkdown_module_css_default = {
			"actions": "dLyUsa_actions",
			"body": "dLyUsa_body",
			"root": "dLyUsa_root",
			"stopped": "dLyUsa_stopped"
		};
		//#endregion
		...
		//#endregion
		//#region \0dsh-css:/Users/jack/java/dsh-java/frontend/packages/client/ui-chat/src/client/chat/GenericCommandCard.module.css.mjs
		const css$6 = "._2YaSdq_root{flex-direction:column;display:flex}._2YaSdq_row{position:relative;overflow:hidden}._2YaSdq_root[data-state=running] ._2YaSdq_row:after{content:\"\";inset-block:0;background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite _2YaSdq_dsh-command-row-sweep;position:absolute;left:0}@keyframes _2YaSdq_dsh-command-row-sweep{0%{left:-300px}90%,to{left:100%}}._2YaSdq_leading{flex-shrink:0}._2YaSdq_chevron{color:var(--dsw-alias-label-secondary)}._2YaSdq_title{font-weight:400}._2YaSdq_separator{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}._2YaSdq_summary{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));text-overflow:ellipsis;white-space:nowrap;flex:auto;overflow:hidden}._2YaSdq_summary[data-error],._2YaSdq_body[data-error]{color:var(--dsw-alias-state-error-primary)}._2YaSdq_body{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);max-height:260px;color:var(--dsw-alias-label-primary);font:var(--dsw-font-markdown-code-block-small);white-space:pre-wrap;border-radius:12px;margin:4px 0 4px 4px;padding:12px 16px;overflow:auto}@media (prefers-reduced-motion:reduce){._2YaSdq_root[data-state=running] ._2YaSdq_row:after{animation:none}}";
		...
		var GenericCommandCard_module_css_default = {
			"body": "_2YaSdq_body",
			"chevron": "_2YaSdq_chevron",
			"dsh-command-row-sweep": "_2YaSdq_dsh-command-row-sweep",
			"leading": "_2YaSdq_leading",
			"root": "_2YaSdq_root",
			"row": "_2YaSdq_row",
			"separator": "_2YaSdq_separator",
			"summary": "_2YaSdq_summary",
			"title": "_2YaSdq_title"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/jack/java/dsh-java/frontend/packages/client/ui-chat/src/client/chat/TurnProcessNodeView.module.css.mjs
		const css$5 = "._2AewvG_root{box-sizing:border-box;border:none;border-bottom:1px solid var(--dsw-alias-border-l2);width:100%;min-width:0;height:33px;color:var(--dsw-alias-label-secondary);cursor:pointer;text-align:left;background:0 0;align-items:center;padding:0 0 8px;display:flex}._2AewvG_root:not([data-open]){margin-bottom:8px}._2AewvG_chevron{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;margin-left:6px;transition:transform .1s;transform:rotate(-90deg)}._2AewvG_root[data-open] ._2AewvG_chevron{transform:rotate(0)}._2AewvG_label{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:14px;line-height:24px;overflow:hidden}@media (prefers-reduced-motion:reduce){._2AewvG_chevron{transition:none}}";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/jack/java/dsh-java/frontend/packages/client/ui-chat/src/client/chat/TurnUsageDisclosure.module.css.mjs
		const css$4 = ".SPIJPW_root{min-width:0}.SPIJPW_root[data-open]{padding-bottom:4px}.SPIJPW_root [data-disclosure-row]:focus-visible{outline:2px solid var(--dsw-alias-label-tertiary);outline-offset:-2px;border-radius:6px}.SPIJPW_chevron{color:var(--dsw-alias-label-secondary)}.SPIJPW_separator{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.SPIJPW_summary{min-width:0;color:var(--dsw-alias-label-tertiary);font-size:var(--dsh-content-font-size-secondary,13px);font-variant-numeric:tabular-nums;line-height:calc(24px + var(--dsh-content-font-delta,0px));text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.SPIJPW_details{box-sizing:border-box;width:calc(100% - 22px - var(--dsh-content-font-delta,0px));margin:4px 0 0 calc(22px + var(--dsh-content-font-delta,0px));background:var(--dsw-alias-markdown-code-block);color:var(--dsw-alias-label-tertiary);border-radius:8px;grid-template-columns:minmax(76px,auto) minmax(0,1fr);gap:6px 16px;padding:10px 16px 12px 12px;font-size:12px;line-height:18px;display:grid}.SPIJPW_details dt,.SPIJPW_details dd{min-width:0;margin:0}.SPIJPW_details dd{color:var(--dsw-alias-label-secondary);font-variant-numeric:tabular-nums;text-align:right}.SPIJPW_details .SPIJPW_route{overflow-wrap:anywhere}.SPIJPW_reasoning{color:var(--dsw-alias-label-tertiary);white-space:nowrap}.SPIJPW_totalLabel,.SPIJPW_details .SPIJPW_totalValue{border-top:1px solid var(--dsw-alias-separator-primary);color:var(--dsw-alias-label-primary);padding-top:6px}@media (width<=480px){.SPIJPW_details{gap-inline:10px;grid-template-columns:minmax(72px,auto) minmax(0,1fr)}}";
		...
		var TurnUsageDisclosure_module_css_default = {
			"chevron": "SPIJPW_chevron",
			"details": "SPIJPW_details",
			"reasoning": "SPIJPW_reasoning",
			"root": "SPIJPW_root",
			"route": "SPIJPW_route",
			"separator": "SPIJPW_separator",
			"summary": "SPIJPW_summary",
			"totalLabel": "SPIJPW_totalLabel",
			"totalValue": "SPIJPW_totalValue"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/jack/java/dsh-java/frontend/packages/client/ui-chat/src/client/chat/TurnTailNodeView.module.css.mjs
		const css$3 = ".n-BtGa_root{flex-direction:column;gap:16px;display:flex}.n-BtGa_footer{flex-direction:column;gap:4px;min-width:0;display:flex}.n-BtGa_actions{margin-left:-6px}";
		...
		var TurnTailNodeView_module_css_default = {
			"actions": "n-BtGa_actions",
			"footer": "n-BtGa_footer",
			"root": "n-BtGa_root"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/jack/java/dsh-java/frontend/packages/client/ui-chat/src/client/chat/StatsLine.module.css.mjs
		const css$2 = ".gbhrCa_root{text-align:center;max-width:var(--dsh-chat-content-width);box-sizing:border-box;width:100%;padding:4px calc(var(--dsh-composer-side-clearance) + 16px) 0px;font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(20px + var(--dsh-content-font-delta-secondary,0px));color:var(--dsw-alias-label-tertiary);white-space:nowrap;text-overflow:ellipsis;margin:0 auto;display:block;overflow:hidden}.gbhrCa_sep{color:var(--dsw-alias-separator-primary);margin:0 10px}";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/jack/java/dsh-java/frontend/packages/client/ui-chat/src/client/details/DetailsPanel.module.css.mjs
		const css$1 = ".GJEb6a_root{border-left:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);flex-direction:column;min-width:0;height:100%;display:flex}.GJEb6a_header{border-bottom:1px solid var(--dsw-alias-border-l2);justify-content:space-between;align-items:center;gap:8px;padding:14px 12px 12px;display:flex}.GJEb6a_title{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:14px;font-weight:500;line-height:20px;overflow:hidden}.GJEb6a_close{width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:999px;flex:none;place-items:center;display:grid}.GJEb6a_close:hover{background:var(--dsw-alias-interactive-bg-hover)}.GJEb6a_body{flex:1;min-height:0;padding:12px 16px;overflow-y:auto}.GJEb6a_empty{color:var(--dsw-alias-label-tertiary);padding:8px 0;font-size:13px;line-height:20px}.GJEb6a_section{margin-bottom:16px}.GJEb6a_sectionLabel{color:var(--dsw-alias-label-secondary);margin-bottom:6px;font-size:12px;font-weight:500;line-height:18px}.GJEb6a_code{background:var(--dsw-alias-markdown-code-block);font-family:var(--ds-font-family-code);color:var(--dsw-alias-label-primary);white-space:pre-wrap;word-break:break-word;border-radius:12px;margin:0;padding:16px;font-size:13px;line-height:22px}.GJEb6a_code[data-error]{color:var(--dsw-alias-state-error-primary)}";
		...
		var DetailsPanel_module_css_default = {
			...
			"code": "GJEb6a_code",
			"empty": "GJEb6a_empty",
			"header": "GJEb6a_header",
			"root": "GJEb6a_root",
			"section": "GJEb6a_section",
			"sectionLabel": "GJEb6a_sectionLabel",
			"title": "GJEb6a_title"
		};
		//#endregion
		...
		//#endregion
		//#region \0dsh-css:/Users/jack/java/dsh-java/frontend/packages/client/ui-chat/src/client/settings/TranscriptViewRow.module.css.mjs
		const css = ".wNq8LG_row{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:center;gap:8px;padding:16px 0;display:flex}.wNq8LG_rowText{flex-direction:column;flex:1;gap:4px;min-width:0;padding-right:48px;display:flex}.wNq8LG_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}.wNq8LG_desc{color:var(--dsw-alias-label-tertiary);font-size:12px;font-weight:400;line-height:18px}.wNq8LG_selector{background:var(--dsw-alias-bg-module-platform);height:36px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:18px;align-items:center;gap:12px;padding:0 14px;font-size:14px;line-height:22px;display:inline-flex}.wNq8LG_selector:hover{background:var(--dsw-alias-interactive-bg-hover)}.wNq8LG_chevron{flex:none}";
		...
		var TranscriptViewRow_module_css_default = {
			"chevron": "wNq8LG_chevron",
			"desc": "wNq8LG_desc",
			"row": "wNq8LG_row",
			"rowText": "wNq8LG_rowText",
			"selector": "wNq8LG_selector",
			"title": "wNq8LG_title"
		};
		//#endregion
