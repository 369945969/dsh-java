window.__ModuleLoader__.load({
 ...
 /* istanbul ignore else */
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/jack/java/dsh-java/frontend/packages/client/ui-trajectory/src/client/TrajectoryTable.module.css.mjs
		const css$3 = ".JpO2ka_split{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);background:var(--dsw-alias-bg-layer-1);flex:1;width:100%;min-height:0;display:flex;position:relative;overflow:hidden;container-type:inline-size}.JpO2ka_tablePane{min-width:0;padding-bottom:var(--dsh-trajectory-bottom-clearance,0px);flex:1;position:relative;overflow:hidden auto;container:JpO2ka_trajectory-table/inline-size}.JpO2ka_historyLoading{z-index:5;pointer-events:none;height:0;position:sticky;top:0;overflow:visible}.JpO2ka_historyLoadingBar{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);width:100%;height:30px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xxs-12);justify-content:center;align-items:center;gap:6px;display:flex}.JpO2ka_historyLoadingSpinner{box-sizing:border-box;border:1.5px solid var(--dsw-alias-border-l2);border-top-color:var(--dsw-alias-state-business-primary);border-radius:50%;width:10px;height:10px;animation:.7s linear infinite JpO2ka_history-loading-spin}.JpO2ka_table tbody .JpO2ka_historyLoadRow td{height:30px;padding:0}.JpO2ka_table tbody .JpO2ka_historyLoadRow+tr[data-turn-start=true] td:before{content:none}.JpO2ka_historyLoadButton{background:var(--dsw-alias-bg-layer-1);width:100%;height:29px;color:var(--dsw-alias-label-secondary);cursor:pointer;font:var(--dsw-font-xxs-12);border:0;justify-content:center;align-items:center;gap:6px;display:flex}.JpO2ka_historyLoadButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.JpO2ka_historyLoadButton:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-2px}.JpO2ka_historyLoadButton:disabled{cursor:default}.JpO2ka_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}.JpO2ka_table:not([data-scroll-ready=true]){visibility:hidden}@keyframes JpO2ka_history-loading-spin{to{transform:rotate(360deg)}}@media (prefers-reduced-motion:reduce){.JpO2ka_historyLoadingSpinner{animation:none}}.JpO2ka_table{--trajectory-turn-accent:color-mix(in srgb, var(--dsw-static-blue-500) 22%, var(--dsw-alias-bg-layer-1));border-spacing:0;table-layout:fixed;width:100%;min-width:0;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);font:var(--dsw-font-xxs-12)}.JpO2ka_eventColumn{width:122px}.JpO2ka_contentColumn{width:auto}.JpO2ka_table th{z-index:3;box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);height:30px;color:var(--dsw-alias-label-tertiary);background:var(--dsw-specific-sidebar-fill);font:var(--dsw-font-xxs-12);text-align:left;text-overflow:ellipsis;user-select:none;white-space:nowrap;padding:0 8px;font-weight:500;position:sticky;top:0;overflow:hidden}.JpO2ka_eventHeader{text-align:right!important;padding-right:4px!important}.JpO2ka_table td{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l1);text-overflow:ellipsis;white-space:nowrap;height:30px;padding:0 8px;overflow:hidden}.JpO2ka_table tbody .JpO2ka_virtualSpacer{pointer-events:none}.JpO2ka_table tbody .JpO2ka_virtualSpacer td{height:var(--trajectory-virtual-spacer-height);border:0;padding:0}.JpO2ka_table tbody tr:not([data-collapsed-summary]):not([data-virtual-spacer]):not([data-history-load]){cursor:default;transition:background-color .12s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out);outline:none}.JpO2ka_table tbody tr[data-timeline-focus=outside]{opacity:.24}.JpO2ka_table tbody tr:not([data-collapsed-summary]):not([data-virtual-spacer]):not([data-history-load]):not([data-selected=true]):hover{background:var(--dsw-alias-interactive-bg-hover)}.JpO2ka_table tbody tr[data-request-only=true]:hover{background:0 0}.JpO2ka_table tbody tr[data-request-only=true] td{border-bottom:0;height:0;padding-top:0;padding-bottom:0}.JpO2ka_table tbody tr[data-terminal-request-boundary=true] td{height:9px}.JpO2ka_table tbody tr[data-request-only=true] .JpO2ka_turnRail{top:-15px;bottom:0}.JpO2ka_table tbody tr:not([data-collapsed-summary]):focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-state-business-primary)}.JpO2ka_table tbody tr[data-selected=true]{background:var(--dsw-alias-interactive-bg-active)}.JpO2ka_requestBoundaryControl{--request-boundary-base-left:12px;z-index:6;top:-8px;left:calc(var(--request-boundary-base-left) + var(--request-boundary-offset,0px));cursor:pointer;background:0 0;border:0;width:16px;height:16px;padding:0;position:absolute}.JpO2ka_requestBoundaryControl:before{background:var(--dsw-alias-label-caption);width:5px;height:5px;box-shadow:0 0 0 2px var(--dsw-alias-bg-layer-1), 0 0 0 3px transparent;content:\"\";transition:background .12s var(--ds-ease-in-out), box-shadow .12s var(--ds-ease-in-out);border-radius:50%;position:absolute;top:5.5px;left:5.5px}.JpO2ka_requestBoundaryControl:after{border:1px solid var(--dsw-alias-border-l1);width:max-content;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);content:attr(data-label);font:9px/12px var(--ds-font-family-code);opacity:0;pointer-events:none;transition:opacity .12s var(--ds-ease-in-out), transform .12s var(--ds-ease-in-out);user-select:none;white-space:nowrap;border-radius:2px;padding:0 4px;position:absolute;top:2px;left:17px;transform:translate(-2px);box-shadow:0 2px 6px #0000001f}.JpO2ka_requestBoundaryControl:hover:before,.JpO2ka_requestBoundaryControl:focus-visible:before{background:var(--dsw-alias-brand-primary-new-colorprimary-new-color)}.JpO2ka_requestBoundaryControlActive:before,.JpO2ka_requestBoundaryControlActive:hover:before,.JpO2ka_requestBoundaryControlActive:focus-visible:before{background:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 18%, var(--dsw-alias-bg-layer-1));box-shadow:0 0 0 1.5px var(--dsw-alias-brand-primary-new-colorprimary-new-color)}.JpO2ka_requestBoundaryControl[data-request-status=error]:before,.JpO2ka_requestBoundaryControl[data-request-status=error]:hover:before,.JpO2ka_requestBoundaryControl[data-request-status=error]:focus-visible:before{background:var(--dsw-alias-state-error-primary)}.JpO2ka_requestBoundaryControl:hover:after,.JpO2ka_requestBoundaryControl:focus-visible:after{opacity:1;transform:translate(0)}.JpO2ka_requestBoundaryControl:focus-visible{outline:none}.JpO2ka_table tbody tr:has(.JpO2ka_requestBoundaryControl:hover):not([data-selected=true]){background:0 0}.JpO2ka_event{position:relative}.JpO2ka_turnRail,.JpO2ka_selectionRail{background:var(--dsw-alias-brand-primary-new-colorprimary-new-color);pointer-events:none;position:absolute;left:0}.JpO2ka_turnRail{z-index:4;background:var(--trajectory-turn-accent);width:2px;top:-1px;bottom:-1px}.JpO2ka_table tbody tr[data-turn-end=true] .JpO2ka_turnRail{bottom:0}.JpO2ka_selectionRail{z-index:5;width:3px;top:0;bottom:0}.JpO2ka_table tbody tr[data-error=true] .JpO2ka_turnRail{background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 22%, var(--dsw-alias-bg-layer-1))}.JpO2ka_table tbody tr[data-error=true] .JpO2ka_selectionRail{background:var(--dsw-alias-state-error-primary)}.JpO2ka_table tbody tr[data-turn-start=true] td{position:relative;overflow:visible}.JpO2ka_table tbody tr[data-turn-start=true]:not(:first-child) td:before{z-index:1;background:var(--dsw-alias-border-l1);content:\"\";pointer-events:none;height:2px;position:absolute;top:0;left:0;right:0;transform:translateY(-50%)}.JpO2ka_event{padding-left:36px!important;padding-right:4px!important;overflow:visible!important}.JpO2ka_turnLabel{z-index:3;box-sizing:border-box;width:max-content;color:var(--dsw-alias-label-tertiary);background:var(--dsw-alias-bg-module-platform);font:8px/10px var(--ds-font-family-code);font-variant-numeric:tabular-nums;user-select:none;white-space:nowrap;border-radius:0 0 2px;flex:none;align-items:center;padding:1px 5px;display:inline-grid;position:absolute;top:0;left:0}.JpO2ka_turnLabelFull,.JpO2ka_turnLabelCompact{opacity:1;white-space:nowrap;grid-area:1/1;max-width:64px;overflow:hidden}.JpO2ka_turnLabelCompact{opacity:0;max-width:0}.JpO2ka_turnLabelActive{color:color-mix(in srgb, var(--dsw-static-blue-500) 55%, var(--dsw-alias-label-tertiary));background:var(--trajectory-turn-accent)}.JpO2ka_eventInner{justify-content:flex-start;align-items:center;min-width:0;height:100%;display:flex}.JpO2ka_kindSlot{flex:none;justify-content:flex-end;align-items:flex-end;width:76px;display:flex}.JpO2ka_kindSlot [role=tooltip]{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);box-shadow:var(--dsw-shadow-lv2);color:var(--dsw-alias-label-primary)}.JpO2ka_content{color:var(--dsw-alias-label-primary);padding-left:4px!important}.JpO2ka_kindTag{box-sizing:border-box;letter-spacing:.035em;user-select:none;border:1px solid #0000;border-radius:4px;flex:none;align-items:center;height:19px;padding:0 5px;font-size:10px;font-weight:650;line-height:16px;display:inline-flex}.JpO2ka_kindTagIcon{opacity:0;flex:none;justify-content:center;align-items:center;width:0;height:13px;display:inline-flex;overflow:hidden;transform:scale(.8)}.JpO2ka_kindTagLabel{opacity:1;white-space:nowrap;max-width:72px;display:inline-block;overflow:hidden}.JpO2ka_table .JpO2ka_kindSlot .JpO2ka_message{justify-content:center;width:100%}@container JpO2ka_trajectory-table (width<=620px){.JpO2ka_eventColumn{width:50px}.JpO2ka_event{padding-left:28px!important;padding-right:3px!important}.JpO2ka_requestBoundaryControl{--request-boundary-base-left:6px}.JpO2ka_kindSlot{width:19px}.JpO2ka_kindTag,.JpO2ka_table .JpO2ka_kindSlot .JpO2ka_message{justify-content:center;width:19px;padding-left:0;padding-right:0}.JpO2ka_kindTagIcon{opacity:1;width:13px;transform:scale(1)}.JpO2ka_kindTagLabel,.JpO2ka_turnLabelFull{opacity:0;max-width:0}.JpO2ka_turnLabelCompact{opacity:1;max-width:64px}}@media (prefers-reduced-motion:no-preference){.JpO2ka_eventColumn,.JpO2ka_event,.JpO2ka_requestBoundaryControl,.JpO2ka_kindSlot,.JpO2ka_kindTag,.JpO2ka_kindTagIcon,.JpO2ka_kindTagLabel,.JpO2ka_turnLabelFull,.JpO2ka_turnLabelCompact{transition-duration:.18s;transition-timing-function:var(--ds-ease-in-out)}.JpO2ka_eventColumn,.JpO2ka_kindSlot{transition-property:width}.JpO2ka_event{transition-property:padding-right,padding-left}.JpO2ka_requestBoundaryControl{transition-property:left}.JpO2ka_kindTag{transition-property:padding-right,padding-left}.JpO2ka_kindTagIcon{transition-property:width,opacity,transform}.JpO2ka_kindTagLabel,.JpO2ka_turnLabelFull,.JpO2ka_turnLabelCompact{transition-property:max-width,opacity}}.JpO2ka_user{color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-state-business-tertiary)}.JpO2ka_systemNeutral{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-module-platform)}.JpO2ka_contextGreen{color:color-mix(in srgb, var(--dsw-alias-state-success-primary) 68%, var(--dsw-alias-label-secondary));background:var(--dsw-alias-state-success-tertiary)}.JpO2ka_compacted{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-module-platform)}.JpO2ka_compactedSummary{font:var(--dsw-font-xs-13);margin-top:12px;padding:0 0 14px}.JpO2ka_promptDiffSections{flex-direction:column;gap:14px;max-height:100%;padding:10px 14px 14px;display:flex;overflow:auto}.JpO2ka_promptDiffSection{min-width:0}.JpO2ka_promptDiffTitle{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-strong-13);user-select:none;margin:0 0 6px}.JpO2ka_promptDiff{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);font:11px/17px var(--ds-font-family-code);white-space:pre;margin:0;overflow:auto}.JpO2ka_promptDiff span{min-width:max-content;padding:0 6px;display:block}.JpO2ka_promptDiffLinemeta{color:var(--dsw-alias-label-caption);background:var(--dsw-alias-bg-module-platform);user-select:none}.JpO2ka_promptDiffLinecontext{color:var(--dsw-alias-label-secondary)}.JpO2ka_promptDiffLineadded{color:color-mix(in srgb, var(--dsw-alias-state-success-primary) 72%, var(--dsw-alias-label-primary));background:var(--dsw-alias-state-success-tertiary)}.JpO2ka_promptDiffLineremoved{color:var(--dsw-alias-state-error-primary);background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 12%, var(--dsw-alias-bg-layer-1))}.JpO2ka_assistantVioletBright{color:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 60%, var(--dsw-alias-state-error-secondary));background:color-mix(in srgb, color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 55%, var(--dsw-alias-state-error-secondary)) 15%, var(--dsw-alias-bg-layer-1))}.JpO2ka_toolAmber{color:var(--dsw-alias-state-warn-label);background:var(--dsw-alias-state-warn-tertiary)}.JpO2ka_subtoolAmber{color:color-mix(in srgb, var(--dsw-alias-state-warn-label) 62%, var(--dsw-alias-label-tertiary));background:color-mix(in srgb, var(--dsw-alias-state-warn-tertiary) 58%, var(--dsw-alias-bg-layer-1))}.JpO2ka_contentText{text-overflow:ellipsis;white-space:nowrap;min-width:0;display:block;overflow:hidden}.JpO2ka_toolCallOnly{color:var(--dsw-alias-label-tertiary)}.JpO2ka_table tbody tr[data-collapsed-summary=turn] td,.JpO2ka_table tbody tr[data-collapsed-summary=assistant] td{height:20px}.JpO2ka_table tbody tr[data-collapsed-summary]{cursor:pointer;transition:background-color .12s var(--ds-ease-in-out);outline:none}.JpO2ka_table tbody tr[data-collapsed-summary]:hover{background:var(--dsw-alias-interactive-bg-hover)}.JpO2ka_table tbody tr[data-collapsed-summary]:focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-state-business-primary)}.JpO2ka_collapsedTurnContent{min-width:0;color:var(--dsw-alias-label-secondary);align-items:center;font-size:12px;line-height:16px;display:flex}.JpO2ka_collapsedTurnEllipsis{color:var(--dsw-alias-label-tertiary);user-select:none;flex:none;margin-right:6px;font-weight:600}.JpO2ka_collapsedTurnText{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.JpO2ka_resultPreview{grid-template-columns:clamp(180px, var(--trajectory-tool-request-width,calc(36cqw - 56px)), 480px) minmax(0, 1fr);align-items:center;gap:8px;min-width:0;display:grid}.JpO2ka_resultRequest,.JpO2ka_inlineResultText{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.JpO2ka_toolCallNameTypeface{color:var(--dsw-alias-label-primary);font:400 12px/18px Menlo,Consolas,Liberation Mono,PingFang SC,Microsoft YaHei}.JpO2ka_toolCallPayload{color:var(--dsw-alias-label-secondary);font:400 12px/18px var(--ds-font-family-code);margin-left:7px}.JpO2ka_table tbody tr[data-kind=tool] .JpO2ka_contentText,.JpO2ka_table tbody tr[data-kind=subtool] .JpO2ka_contentText,.JpO2ka_table tbody tr[data-kind=tool] .JpO2ka_resultPreview,.JpO2ka_table tbody tr[data-kind=subtool] .JpO2ka_resultPreview{font-family:var(--ds-font-family-code);font-size:12px}.JpO2ka_table tbody tr[data-kind=subtool] .JpO2ka_content{padding-left:26px}.JpO2ka_inlineResult{min-width:0;color:var(--dsw-alias-label-secondary);align-items:center;display:flex}.JpO2ka_noOutputText{color:var(--dsw-alias-label-caption)}.JpO2ka_arrow{color:var(--dsw-alias-label-caption);flex:none;margin-right:8px}.JpO2ka_error,.JpO2ka_overview dd.JpO2ka_error,.JpO2ka_details .JpO2ka_errorPayload{color:var(--dsw-alias-state-error-primary)}.JpO2ka_details .JpO2ka_errorPayload .JpO2ka_resultBlockText{color:inherit}.JpO2ka_details .JpO2ka_jsonPayload.JpO2ka_errorPayload,.JpO2ka_details .JpO2ka_jsonPreview.JpO2ka_errorPayload{--json-tree-property:var(--dsw-alias-state-error-primary);--json-tree-string:var(--dsw-alias-state-error-primary);--json-tree-number:var(--dsw-alias-state-error-primary);--json-tree-keyword:var(--dsw-alias-state-error-primary);--json-tree-punctuation:var(--dsw-alias-state-error-primary);--json-tree-icon:var(--dsw-alias-state-error-primary)}.JpO2ka_details{border-left:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);flex-direction:column;flex:none;width:clamp(320px,38%,440px);min-width:0;max-width:calc(100% - 280px);min-height:0;display:flex;position:relative}.JpO2ka_detailsResizeHandle{z-index:6;cursor:col-resize;touch-action:none;user-select:none;background:0 0;border:0;width:8px;padding:0;position:absolute;top:0;bottom:0;left:-4px}.JpO2ka_detailsResizeHandle:focus-visible{outline:none}.JpO2ka_detailsHeader{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);flex:none;justify-content:space-between;align-items:center;height:42px;padding:0 8px 0 12px;display:flex}.JpO2ka_detailsTitle{min-width:0;color:var(--dsw-alias-label-primary);align-items:center;gap:8px;display:flex}.JpO2ka_requestDetailsDot{background:var(--dsw-alias-label-secondary);border-radius:50%;flex:none;width:5px;height:5px}.JpO2ka_requestDetailsName{font:500 12px/16px var(--ds-font-family-code);flex:none}.JpO2ka_detailsLocation{min-width:0;color:var(--dsw-alias-label-tertiary);font:11px/16px var(--ds-font-family-code);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.JpO2ka_close{width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:0;border-radius:6px;flex:none;justify-content:center;align-items:center;padding:0;font-size:18px;line-height:18px;display:inline-flex}.JpO2ka_close:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.JpO2ka_detailTabs{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);overscroll-behavior-x:contain;scrollbar-width:none;white-space:nowrap;flex:none;gap:1px;width:100%;min-width:0;max-width:100%;height:34px;padding:0 8px;display:flex;overflow:auto hidden}.JpO2ka_detailTabs::-webkit-scrollbar{display:none}.JpO2ka_detailTab{color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xs-13);background:0 0;border:0;flex:none;padding:0 9px;position:relative}.JpO2ka_detailTab:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.JpO2ka_detailTabActive{color:var(--dsw-alias-state-business-primary)}.JpO2ka_detailTabActive:after{background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:1px 1px 0 0;height:2px;position:absolute;bottom:0;left:9px;right:9px}.JpO2ka_close:focus-visible,.JpO2ka_detailTab:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.JpO2ka_detailBody{min-height:0;padding-bottom:var(--dsh-trajectory-bottom-clearance,0px);scrollbar-gutter:stable;flex:1;overflow:hidden auto}.JpO2ka_detailBodySummary{box-sizing:border-box;padding-bottom:calc(12px + var(--dsh-trajectory-bottom-clearance,0px));flex-direction:column;display:flex;overflow:hidden}.JpO2ka_detailBodySummary>.JpO2ka_overview{overscroll-behavior:contain;flex:0 auto;min-height:0;overflow:auto}.JpO2ka_detailBodySummary>.JpO2ka_compactedSummary{flex:1;min-height:0;overflow:auto}.JpO2ka_summaryScrollRegion{--dsh-scrollbar-thumb:transparent;--dsh-scrollbar-thumb-hover:transparent}.JpO2ka_summaryScrollRegion:hover,.JpO2ka_summaryScrollRegion:focus-within{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2)}.JpO2ka_compactedSummary .JpO2ka_markdownPayload{padding-right:18px}.JpO2ka_overview{font:var(--dsw-font-xs-13);margin:0;padding:8px 0}.JpO2ka_overviewParentLinks{gap:14px;display:flex}.JpO2ka_overviewHierarchyNavLink{all:unset;color:var(--dsw-alias-label-secondary);cursor:pointer;font:inherit;opacity:1;align-items:center;gap:1px;display:inline-flex}.JpO2ka_overviewHierarchyNavLink:hover{color:var(--dsw-alias-label-primary)}.JpO2ka_overviewHierarchyJumpIconTight{color:var(--dsw-alias-label-caption);flex:none}.JpO2ka_overviewHierarchyNavLink:hover .JpO2ka_overviewHierarchyJumpIconTight,.JpO2ka_overviewHierarchyNavLink:focus-visible .JpO2ka_overviewHierarchyJumpIconTight{color:var(--dsw-alias-label-primary)}.JpO2ka_overviewHierarchyNavLink:focus-visible{color:var(--dsw-alias-label-primary);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.JpO2ka_overview>div{grid-template-columns:94px minmax(0,1fr);align-items:center;min-height:22px;padding:0 14px;display:grid}.JpO2ka_overview>.JpO2ka_requestTokenDetail dt{padding-left:12px}.JpO2ka_usagePanel{padding:4px 0 10px}.JpO2ka_usageGroup+.JpO2ka_usageGroup{margin-top:8px}.JpO2ka_usageHeading{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-strong-13);user-select:none;margin:0;padding:4px 14px 1px}.JpO2ka_usageGroup .JpO2ka_overview{padding:0}.JpO2ka_overview dt{color:var(--dsw-alias-label-tertiary)}.JpO2ka_overview dd{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;margin:0;overflow:hidden}.JpO2ka_timestampToggle{all:unset;color:inherit;cursor:pointer;font:inherit;user-select:text}.JpO2ka_timestampToggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.JpO2ka_overviewSections{border-top:0;flex-direction:column;flex:1;min-height:min-content;display:flex;overflow:hidden}.JpO2ka_overviewSection{flex-direction:column;flex:1 1 0;min-height:28px;max-height:max-content;display:flex;overflow:hidden}.JpO2ka_overviewSection+.JpO2ka_overviewSection{padding-top:8px}.JpO2ka_overviewHeading{box-sizing:border-box;width:100%;height:28px;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);font:var(--dsw-font-xs-strong-13);user-select:none;flex:none;align-items:flex-end;margin:0;padding:0 0 3px 14px;display:flex}.JpO2ka_overviewTitle{width:max-content;height:auto;color:inherit;cursor:pointer;font:inherit;user-select:none;background:0 0;border:0;flex:none;align-items:center;gap:3px;padding:0;line-height:1;display:inline-flex}.JpO2ka_overviewTitleIcon{color:var(--dsw-alias-label-caption);flex:none}.JpO2ka_overviewTitle:hover .JpO2ka_overviewTitleIcon{color:var(--dsw-alias-label-primary)}.JpO2ka_overviewTitle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.JpO2ka_overviewTitle:focus-visible .JpO2ka_overviewTitleIcon{color:var(--dsw-alias-state-business-primary)}.JpO2ka_overviewPreview{overscroll-behavior:contain;background:var(--dsw-alias-bg-layer-1);flex:1;min-height:0;overflow:auto}.JpO2ka_overviewPreview>:last-child{margin-bottom:0;padding-bottom:0}.JpO2ka_overviewPreview .JpO2ka_jsonPreview>:first-child,.JpO2ka_overviewPreview .JpO2ka_schemaTree>:first-child{padding-bottom:0}.JpO2ka_overviewPreview .JpO2ka_schemaTree{margin-bottom:0}.JpO2ka_overviewPreview .JpO2ka_overview{padding:2px 0 0}.JpO2ka_overviewPreview .JpO2ka_overview>div{min-height:22px}.JpO2ka_markdownPreview,.JpO2ka_markdownPayload{color:var(--dsw-alias-label-primary)}.JpO2ka_markdownPreview>div,.JpO2ka_markdownPayload>div{font:var(--dsw-font-xs-13);gap:8px}.JpO2ka_markdownPreview>div h1,.JpO2ka_markdownPayload>div h1{font:600 16px/22px var(--dsw-font-family)}.JpO2ka_markdownPreview>div h2,.JpO2ka_markdownPayload>div h2{font:600 15px/22px var(--dsw-font-family)}.JpO2ka_markdownPreview>div :where(h3,h4,h5,h6),.JpO2ka_markdownPayload>div :where(h3,h4,h5,h6){font:600 14px/20px var(--dsw-font-family)}.JpO2ka_markdownPreview>div :not(pre)>code,.JpO2ka_markdownPayload>div :not(pre)>code{font:12px/18px var(--ds-font-family-code)}.JpO2ka_markdownPreview>div table,.JpO2ka_markdownPayload>div table{font:var(--dsw-font-xs-13)}.JpO2ka_markdownPreview>div>:first-child{margin-top:0}.JpO2ka_markdownPreview>div>:last-child{margin-bottom:0}.JpO2ka_markdownPreview>div :where(h1,h2,h3){margin:12px 0 6px}.JpO2ka_markdownPreview>div :where(h4,h5,h6){margin:10px 0 5px}.JpO2ka_markdownPreview>div :where(p,ul,ol){margin:8px 0}.JpO2ka_markdownPreview>div li:not(:first-child){margin-top:3px}.JpO2ka_markdownPreview>div blockquote{margin-top:8px}.JpO2ka_markdownPreview>div hr{margin:14px 0}.JpO2ka_markdownPreview>div>.md-code-block{margin:10px 0}.JpO2ka_assistantContent .JpO2ka_markdownPayload,.JpO2ka_assistantContent .JpO2ka_payload{min-height:0}.JpO2ka_thinkingQuote{border-left:2px solid var(--dsw-alias-markdown-citation);color:var(--dsw-alias-label-secondary);background:0 0;margin:6px 14px 0 12px;padding-left:6px}.JpO2ka_thinkingQuoteOnlyPreview{margin-bottom:8px}.JpO2ka_detailBody>.JpO2ka_assistantContentRendered .JpO2ka_thinkingQuote{margin-top:14px}.JpO2ka_thinkingToggle{width:max-content;height:18px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:600 12px/18px var(--dsw-font-family);user-select:none;background:0 0;border:0;align-items:center;gap:2px;padding:0;display:flex}.JpO2ka_thinkingChevron{transition:transform .12s var(--ds-ease-in-out);flex:none}.JpO2ka_thinkingToggle[aria-expanded=true] .JpO2ka_thinkingChevron{transform:rotate(90deg)}.JpO2ka_thinkingToggle:hover{color:var(--dsw-alias-label-secondary)}.JpO2ka_thinkingToggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.JpO2ka_thinkingQuote .JpO2ka_markdownPreview,.JpO2ka_thinkingQuote .JpO2ka_markdownPayload,.JpO2ka_thinkingQuote .JpO2ka_payload{min-height:0;color:var(--dsw-alias-label-secondary);background:0 0;padding:2px 0}.JpO2ka_assistantOutput{background:var(--dsw-alias-bg-layer-1)}.JpO2ka_markdownPreview{padding:6px 14px 8px}.JpO2ka_markdownPayload{min-height:100%;padding:14px}.JpO2ka_jsonPayload{min-height:100%}.JpO2ka_jsonPreview{min-height:0}.JpO2ka_schema{background:var(--dsw-alias-bg-layer-1);min-height:100%}.JpO2ka_schemaPreview{min-height:0}.JpO2ka_schemaIntro{padding:12px 14px 6px}.JpO2ka_schemaPreview .JpO2ka_schemaIntro{padding-top:6px}.JpO2ka_schemaName{color:var(--dsw-alias-label-primary);font:600 12px/18px var(--ds-font-family-code);margin:0}.JpO2ka_schemaDescription{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);white-space:pre-wrap;margin:2px 0 0}.JpO2ka_schemaParameters{min-width:0}.JpO2ka_schemaParametersTitle{color:var(--dsw-alias-label-tertiary);font:600 11px/16px var(--dsw-font-family);user-select:none;margin:0;padding:4px 14px 2px}.JpO2ka_schemaTree{margin:0 6px 8px 0}.JpO2ka_payload{box-sizing:border-box;overflow-wrap:anywhere;min-height:100%;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-markdown-code-block);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;margin:0;padding:14px}.JpO2ka_payloadPreview{min-height:0;padding:6px 14px 8px}.JpO2ka_sourceBlocks{box-sizing:border-box;min-height:100%;padding:12px 14px}.JpO2ka_sourceBlock+.JpO2ka_sourceBlock{margin-top:14px}.JpO2ka_sourceBlockHeader,.JpO2ka_sourceBlockJumpTarget{user-select:none;align-items:center;gap:3px;width:max-content;margin-bottom:3px;display:flex}.JpO2ka_sourceBlockJumpTarget{all:unset;cursor:pointer;user-select:none;align-items:center;gap:3px;width:max-content;margin-bottom:3px;display:flex}.JpO2ka_sourceBlockLabel{color:var(--dsw-alias-label-tertiary);font:11px/16px var(--ds-font-family-code)}.JpO2ka_sourceBlockJumpIcon{color:var(--dsw-alias-label-caption);flex:none}.JpO2ka_sourceBlockJumpTarget:hover .JpO2ka_sourceBlockJumpIcon{color:var(--dsw-alias-label-primary)}.JpO2ka_sourceBlockJumpTarget:focus-visible{outline:none}.JpO2ka_sourceBlockJumpTarget:focus-visible .JpO2ka_sourceBlockJumpIcon{color:var(--dsw-alias-state-business-primary)}.JpO2ka_sourceBlockContent{overflow-wrap:anywhere;color:var(--dsw-alias-label-primary);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;background:0 0;margin:0}.JpO2ka_panelImageLink{cursor:zoom-in;border-radius:4px;width:auto;max-width:100%;display:block;overflow:hidden}.JpO2ka_panelImageLinkPreview{max-height:140px}.JpO2ka_panelImage{border-radius:inherit;background:var(--dsw-alias-bg-base);object-fit:contain;width:auto;max-width:100%;height:auto;max-height:320px;margin:0;display:block}.JpO2ka_panelImageLinkPreview .JpO2ka_panelImage{max-height:140px}.JpO2ka_messageImages{flex-direction:column;gap:8px;margin:8px 14px 14px;display:flex}.JpO2ka_messageImagesPreview{gap:6px;margin:6px 14px 8px}.JpO2ka_assistantToolCalls{box-sizing:border-box;max-width:100%;color:var(--dsw-alias-label-secondary);font:11px/17px var(--ds-font-family-code);margin:2px 14px 12px;padding:0;list-style:none}.JpO2ka_assistantToolCallsPreview{margin-top:2px;margin-bottom:8px}.JpO2ka_assistantToolCalls li{min-width:0}.JpO2ka_assistantToolCallButton{all:unset;box-sizing:border-box;cursor:pointer;border-radius:3px;align-items:center;width:calc(100% + 4px);min-width:0;height:19px;margin-left:-4px;padding:0 4px;display:flex}.JpO2ka_assistantToolCallButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.JpO2ka_assistantToolCallButton:focus-visible{background:var(--dsw-alias-interactive-bg-hover);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.JpO2ka_assistantToolCallIcon{color:var(--dsw-alias-label-caption);flex:none;margin-right:5px}.JpO2ka_assistantToolCallButton:hover .JpO2ka_assistantToolCallIcon,.JpO2ka_assistantToolCallButton:focus-visible .JpO2ka_assistantToolCallIcon{color:var(--dsw-alias-label-secondary)}.JpO2ka_assistantToolCallText{white-space:nowrap;flex:1;min-width:0;display:flex;overflow:hidden}.JpO2ka_assistantToolCallName{color:var(--dsw-alias-label-secondary);flex:none;margin-right:5px;font-weight:500}.JpO2ka_assistantToolCallArgs{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.JpO2ka_systemPrompt{box-sizing:border-box}.JpO2ka_toolCatalog{min-height:100%;padding:8px 0 16px}.JpO2ka_toolCatalogItem{border-bottom:1px solid var(--dsw-alias-border-l1)}.JpO2ka_toolCatalogSummary{box-sizing:border-box;cursor:pointer;user-select:none;grid-template-columns:12px 12px max-content minmax(0,1fr);align-items:center;gap:5px;min-height:30px;padding:4px 12px;list-style:none;display:grid}.JpO2ka_toolCatalogSummary::-webkit-details-marker{display:none}.JpO2ka_toolCatalogSummary:hover{background:var(--dsw-alias-interactive-bg-hover)}.JpO2ka_toolCatalogSummary:focus-visible{background:var(--dsw-alias-interactive-bg-hover);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.JpO2ka_toolCatalogChevron,.JpO2ka_toolCatalogIcon{color:var(--dsw-alias-label-caption)}.JpO2ka_toolCatalogChevron{transition:transform .1s var(--ds-ease-in-out)}.JpO2ka_toolCatalogItem[open] .JpO2ka_toolCatalogChevron{transform:rotate(90deg)}.JpO2ka_toolCatalogName{color:var(--dsw-alias-label-primary);font:500 12px/18px var(--ds-font-family-code)}.JpO2ka_toolCatalogDescription{min-width:0;color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.JpO2ka_toolCatalogDefinition{background:var(--dsw-alias-bg-base);padding:0 0 8px 29px}.JpO2ka_toolCatalogFullDescription{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);white-space:pre-wrap;margin:0;padding:7px 14px 4px 0}.JpO2ka_toolCatalogTree{margin-left:-14px;margin-right:6px}.JpO2ka_resultBlocks{box-sizing:border-box;flex-direction:column;gap:10px;min-height:100%;padding:14px;display:flex}.JpO2ka_resultBlocksPreview{gap:6px;min-height:0;padding:6px 14px 8px}.JpO2ka_resultBlockText{overflow-wrap:anywhere;color:var(--dsw-alias-label-primary);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;background:0 0;margin:0}.JpO2ka_overviewPreview .JpO2ka_noPayload{padding:6px 14px 8px}.JpO2ka_noPayload{color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);margin:0;padding:18px 14px}@media (width<=760px){.JpO2ka_details{z-index:5;border-left-color:var(--dsw-alias-border-l3);width:min(92%,420px);max-width:92%;position:absolute;top:0;bottom:0;right:0;box-shadow:-12px 0 32px #00000024}}";
		...
		var TrajectoryTable_module_css_default = {
			"arrow": "JpO2ka_arrow",
			"assistantContent": "JpO2ka_assistantContent",
			"assistantContentRendered": "JpO2ka_assistantContentRendered",
			"assistantOutput": "JpO2ka_assistantOutput",
			"assistantToolCallArgs": "JpO2ka_assistantToolCallArgs",
			"assistantToolCallButton": "JpO2ka_assistantToolCallButton",
			"assistantToolCallIcon": "JpO2ka_assistantToolCallIcon",
			"assistantToolCallName": "JpO2ka_assistantToolCallName",
			"assistantToolCallText": "JpO2ka_assistantToolCallText",
			"assistantToolCalls": "JpO2ka_assistantToolCalls",
			"assistantToolCallsPreview": "JpO2ka_assistantToolCallsPreview",
			"assistantVioletBright": "JpO2ka_assistantVioletBright",
			"close": "JpO2ka_close",
			"collapsedTurnContent": "JpO2ka_collapsedTurnContent",
			"collapsedTurnEllipsis": "JpO2ka_collapsedTurnEllipsis",
			"collapsedTurnText": "JpO2ka_collapsedTurnText",
			"compacted": "JpO2ka_compacted",
			"compactedSummary": "JpO2ka_compactedSummary",
			"content": "JpO2ka_content",
			"contentColumn": "JpO2ka_contentColumn",
			"contentText": "JpO2ka_contentText",
			"contextGreen": "JpO2ka_contextGreen",
			"detailBody": "JpO2ka_detailBody",
			"detailBodySummary": "JpO2ka_detailBodySummary",
			"detailTab": "JpO2ka_detailTab",
			"detailTabActive": "JpO2ka_detailTabActive",
			"detailTabs": "JpO2ka_detailTabs",
			"details": "JpO2ka_details",
			"detailsHeader": "JpO2ka_detailsHeader",
			"detailsLocation": "JpO2ka_detailsLocation",
			"detailsResizeHandle": "JpO2ka_detailsResizeHandle",
			"detailsTitle": "JpO2ka_detailsTitle",
			"error": "JpO2ka_error",
			"errorPayload": "JpO2ka_errorPayload",
			"event": "JpO2ka_event",
			"eventColumn": "JpO2ka_eventColumn",
			"eventHeader": "JpO2ka_eventHeader",
			"eventInner": "JpO2ka_eventInner",
			"history-loading-spin": "JpO2ka_history-loading-spin",
			"historyLoadButton": "JpO2ka_historyLoadButton",
			"historyLoadRow": "JpO2ka_historyLoadRow",
			"historyLoading": "JpO2ka_historyLoading",
			"historyLoadingBar": "JpO2ka_historyLoadingBar",
			"historyLoadingSpinner": "JpO2ka_historyLoadingSpinner",
			"inlineResult": "JpO2ka_inlineResult",
			"inlineResultText": "JpO2ka_inlineResultText",
			"jsonPayload": "JpO2ka_jsonPayload",
			"jsonPreview": "JpO2ka_jsonPreview",
			"kindSlot": "JpO2ka_kindSlot",
			"kindTag": "JpO2ka_kindTag",
			"kindTagIcon": "JpO2ka_kindTagIcon",
			"kindTagLabel": "JpO2ka_kindTagLabel",
			"markdownPayload": "JpO2ka_markdownPayload",
			"markdownPreview": "JpO2ka_markdownPreview",
			"message": "JpO2ka_message",
			"messageImages": "JpO2ka_messageImages",
			"messageImagesPreview": "JpO2ka_messageImagesPreview",
			"noOutputText": "JpO2ka_noOutputText",
			"noPayload": "JpO2ka_noPayload",
			"overview": "JpO2ka_overview",
			"overviewHeading": "JpO2ka_overviewHeading",
			"overviewHierarchyJumpIconTight": "JpO2ka_overviewHierarchyJumpIconTight",
			"overviewHierarchyNavLink": "JpO2ka_overviewHierarchyNavLink",
			"overviewParentLinks": "JpO2ka_overviewParentLinks",
			"overviewPreview": "JpO2ka_overviewPreview",
			"overviewSection": "JpO2ka_overviewSection",
			"overviewSections": "JpO2ka_overviewSections",
			"overviewTitle": "JpO2ka_overviewTitle",
			"overviewTitleIcon": "JpO2ka_overviewTitleIcon",
			"panelImage": "JpO2ka_panelImage",
			"panelImageLink": "JpO2ka_panelImageLink",
			"panelImageLinkPreview": "JpO2ka_panelImageLinkPreview",
			"payload": "JpO2ka_payload",
			"payloadPreview": "JpO2ka_payloadPreview",
			"promptDiff": "JpO2ka_promptDiff",
			"promptDiffLineadded": "JpO2ka_promptDiffLineadded",
			"promptDiffLinecontext": "JpO2ka_promptDiffLinecontext",
			"promptDiffLinemeta": "JpO2ka_promptDiffLinemeta",
			"promptDiffLineremoved": "JpO2ka_promptDiffLineremoved",
			"promptDiffSection": "JpO2ka_promptDiffSection",
			"promptDiffSections": "JpO2ka_promptDiffSections",
			"promptDiffTitle": "JpO2ka_promptDiffTitle",
			"requestBoundaryControl": "JpO2ka_requestBoundaryControl",
			"requestBoundaryControlActive": "JpO2ka_requestBoundaryControlActive",
			"requestDetailsDot": "JpO2ka_requestDetailsDot",
			"requestDetailsName": "JpO2ka_requestDetailsName",
			"requestTokenDetail": "JpO2ka_requestTokenDetail",
			"resultBlockText": "JpO2ka_resultBlockText",
			"resultBlocks": "JpO2ka_resultBlocks",
			"resultBlocksPreview": "JpO2ka_resultBlocksPreview",
			"resultPreview": "JpO2ka_resultPreview",
			"resultRequest": "JpO2ka_resultRequest",
			"schema": "JpO2ka_schema",
			"schemaDescription": "JpO2ka_schemaDescription",
			"schemaIntro": "JpO2ka_schemaIntro",
			"schemaName": "JpO2ka_schemaName",
			"schemaParameters": "JpO2ka_schemaParameters",
			"schemaParametersTitle": "JpO2ka_schemaParametersTitle",
			"schemaPreview": "JpO2ka_schemaPreview",
			"schemaTree": "JpO2ka_schemaTree",
			"selectionRail": "JpO2ka_selectionRail",
			"sourceBlock": "JpO2ka_sourceBlock",
			"sourceBlockContent": "JpO2ka_sourceBlockContent",
			"sourceBlockHeader": "JpO2ka_sourceBlockHeader",
			"sourceBlockJumpIcon": "JpO2ka_sourceBlockJumpIcon",
			"sourceBlockJumpTarget": "JpO2ka_sourceBlockJumpTarget",
			"sourceBlockLabel": "JpO2ka_sourceBlockLabel",
			"sourceBlocks": "JpO2ka_sourceBlocks",
			"split": "JpO2ka_split",
			"subtoolAmber": "JpO2ka_subtoolAmber",
			"summaryScrollRegion": "JpO2ka_summaryScrollRegion",
			"systemNeutral": "JpO2ka_systemNeutral",
			"systemPrompt": "JpO2ka_systemPrompt",
			"table": "JpO2ka_table",
			"tablePane": "JpO2ka_tablePane",
			"thinkingChevron": "JpO2ka_thinkingChevron",
			"thinkingQuote": "JpO2ka_thinkingQuote",
			"thinkingQuoteOnlyPreview": "JpO2ka_thinkingQuoteOnlyPreview",
			"thinkingToggle": "JpO2ka_thinkingToggle",
			"timestampToggle": "JpO2ka_timestampToggle",
			"toolAmber": "JpO2ka_toolAmber",
			"toolCallNameTypeface": "JpO2ka_toolCallNameTypeface",
			"toolCallOnly": "JpO2ka_toolCallOnly",
			"toolCallPayload": "JpO2ka_toolCallPayload",
			"toolCatalog": "JpO2ka_toolCatalog",
			"toolCatalogChevron": "JpO2ka_toolCatalogChevron",
			"toolCatalogDefinition": "JpO2ka_toolCatalogDefinition",
			"toolCatalogDescription": "JpO2ka_toolCatalogDescription",
			"toolCatalogFullDescription": "JpO2ka_toolCatalogFullDescription",
			"toolCatalogIcon": "JpO2ka_toolCatalogIcon",
			"toolCatalogItem": "JpO2ka_toolCatalogItem",
			"toolCatalogName": "JpO2ka_toolCatalogName",
			"toolCatalogSummary": "JpO2ka_toolCatalogSummary",
			"toolCatalogTree": "JpO2ka_toolCatalogTree",
			"trajectory-table": "JpO2ka_trajectory-table",
			"turnLabel": "JpO2ka_turnLabel",
			"turnLabelActive": "JpO2ka_turnLabelActive",
			"turnLabelCompact": "JpO2ka_turnLabelCompact",
			"turnLabelFull": "JpO2ka_turnLabelFull",
			"turnRail": "JpO2ka_turnRail",
			"usageGroup": "JpO2ka_usageGroup",
			"usageHeading": "JpO2ka_usageHeading",
			"usagePanel": "JpO2ka_usagePanel",
			"user": "JpO2ka_user",
			"virtualSpacer": "JpO2ka_virtualSpacer",
			"visuallyHidden": "JpO2ka_visuallyHidden"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/jack/java/dsh-java/frontend/packages/client/ui-trajectory/src/client/TrajectoryToolbar.module.css.mjs
		const css$2 = ".cMlbSq_root{z-index:4;box-sizing:border-box;width:100%;height:var(--dsh-trajectory-toolbar-height);border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);position:sticky;top:0}.cMlbSq_inner{box-sizing:border-box;align-items:center;gap:8px;width:100%;height:100%;padding:0 6px;display:flex}.cMlbSq_actions{flex:none;align-items:center;gap:2px;display:flex}.cMlbSq_toggle{height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:3px;flex:none;align-items:center;gap:4px;padding:0 7px;display:inline-flex}.cMlbSq_toggle:hover,.cMlbSq_toggle[aria-pressed=true]{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.cMlbSq_toggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.cMlbSq_toggleIcon{stroke:currentColor;stroke-width:1.25px;stroke-linecap:round;stroke-linejoin:round;flex:none;width:12px;height:12px}.cMlbSq_control{box-sizing:border-box;width:88px;height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:0;flex:none;justify-content:center;align-items:center;gap:4px;padding:0 5px;display:inline-flex}.cMlbSq_control[hidden]{display:none}.cMlbSq_control:hover:not(:disabled),.cMlbSq_control[aria-checked=true],.cMlbSq_control[aria-pressed=true]{color:var(--dsw-alias-label-primary)}.cMlbSq_control:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.cMlbSq_control:disabled{color:var(--dsw-alias-label-dimmed);cursor:not-allowed}.cMlbSq_controlTrack{background:var(--dsw-alias-border-l2);width:20px;height:10px;transition:background-color .12s var(--ds-ease-in-out);border-radius:5px;flex:none;display:inline-block;position:relative}.cMlbSq_controlThumb{background:var(--dsw-alias-bg-layer-1);width:6px;height:6px;transition:transform .12s var(--ds-ease-in-out);border-radius:50%;position:absolute;top:2px;left:2px}.cMlbSq_controlTrack[data-on=true]{background:var(--dsw-alias-state-business-primary)}.cMlbSq_controlTrack[data-on=true] .cMlbSq_controlThumb{transform:translate(10px)}.cMlbSq_action{height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:3px;flex:none;align-items:center;gap:4px;padding:0 5px;display:inline-flex}.cMlbSq_action:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.cMlbSq_action:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.cMlbSq_actionIcon{color:var(--dsw-alias-label-tertiary);font:14px/14px var(--ds-font-family-code)}.cMlbSq_search{border:1px solid var(--dsw-alias-border-l2);min-width:84px;height:22px;color:var(--dsw-alias-label-caption);background:var(--dsw-alias-bg-layer-2);border-radius:4px;flex:0 164px;align-items:center;gap:4px;margin-left:auto;padding:0 6px;display:flex}.cMlbSq_search:hover{border-color:var(--dsw-alias-label-caption)}.cMlbSq_search:focus-within{border-color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-bg-layer-1)}.cMlbSq_searchIcon{flex:none}.cMlbSq_searchInput{width:100%;min-width:0;color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxs-12);background:0 0;border:0;outline:0;padding:0}.cMlbSq_searchInput::placeholder{color:var(--dsw-alias-label-caption)}.cMlbSq_searchInput::-webkit-search-cancel-button{cursor:pointer;width:12px;height:12px}";
		...
		var TrajectoryToolbar_module_css_default = {
			"action": "cMlbSq_action",
			"actionIcon": "cMlbSq_actionIcon",
			"actions": "cMlbSq_actions",
			"control": "cMlbSq_control",
			"controlThumb": "cMlbSq_controlThumb",
			"controlTrack": "cMlbSq_controlTrack",
			"inner": "cMlbSq_inner",
			"root": "cMlbSq_root",
			"search": "cMlbSq_search",
			"searchIcon": "cMlbSq_searchIcon",
			"searchInput": "cMlbSq_searchInput",
			"toggle": "cMlbSq_toggle",
			"toggleIcon": "cMlbSq_toggleIcon"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/jack/java/dsh-java/frontend/packages/client/ui-trajectory/src/client/TrajectoryTimeline.module.css.mjs
		const css$1 = ".LlSJ9q_root{z-index:1;isolation:isolate;border-bottom:1px solid var(--dsw-alias-border-l2);user-select:none;flex:none;position:relative}.LlSJ9q_root [role=tooltip]{font:var(--dsw-font-xxxs-11)}.LlSJ9q_plot{background:var(--dsw-alias-bg-layer-2);grid-template-columns:44px minmax(0,1fr);height:50px;display:grid;overflow:hidden}.LlSJ9q_labels{border-right:1px solid var(--dsw-alias-border-l1);color:var(--dsw-alias-label-caption);font:var(--dsw-font-xs-13);font-size:10px;line-height:1;position:relative}.LlSJ9q_labels span{text-align:right;justify-content:flex-end;align-items:center;height:8px;display:flex;position:absolute;right:3px}.LlSJ9q_labels span:first-child{top:7px}.LlSJ9q_labels span:nth-child(2){top:21px}.LlSJ9q_labels span:nth-child(3){top:35px}.LlSJ9q_track{cursor:crosshair;touch-action:none;position:relative;overflow:hidden}.LlSJ9q_track[data-panning=true]{cursor:grabbing}.LlSJ9q_earlierHistory{z-index:5;appearance:none;box-sizing:border-box;background:linear-gradient(to right, var(--dsw-alias-bg-layer-2) 0, var(--dsw-alias-bg-layer-2) 38%, transparent 100%);width:28px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);opacity:.72;cursor:pointer;border:0;outline:none;justify-content:flex-start;align-items:center;padding-left:3px;line-height:1;display:flex;position:absolute;top:0;bottom:0;left:0}.LlSJ9q_earlierHistory:hover{opacity:1}.LlSJ9q_earlierHistory[aria-disabled=true]{cursor:default}.LlSJ9q_earlierHistory:focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-border-l2)}.LlSJ9q_empty{color:var(--dsw-alias-label-caption);font:var(--dsw-font-xs-13);position:absolute;top:50%;left:50%;transform:translate(-50%,-50%)}.LlSJ9q_track:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.LlSJ9q_lanes{z-index:2;top:7px;bottom:7px;left:var(--trajectory-domain-left);width:var(--trajectory-domain-width);position:absolute}.LlSJ9q_turnBoundaries{z-index:3;top:0;bottom:0;left:var(--trajectory-domain-left);width:var(--trajectory-domain-width);pointer-events:none;position:absolute}@media (prefers-reduced-motion:no-preference){.LlSJ9q_lanes[data-animate-viewport=true],.LlSJ9q_turnBoundaries[data-animate-viewport=true]{transition:left .18s ease-out}}.LlSJ9q_turnBoundary{top:0;bottom:0;left:var(--trajectory-turn-left);background:var(--dsw-alias-border-l2);width:1px;position:absolute}.LlSJ9q_span{top:calc(var(--trajectory-span-lane) * 14px);left:calc(var(--trajectory-span-left) + var(--trajectory-span-gap));width:max(2px, calc(var(--trajectory-span-width) - var(--trajectory-span-gap) - var(--trajectory-span-gap)));background:var(--dsw-alias-label-secondary);opacity:.78;border-radius:1px;min-width:2px;height:8px;position:absolute}.LlSJ9q_span[data-timeline-span=user]{background:var(--dsw-alias-state-business-primary)}.LlSJ9q_span[data-timeline-span=context]{background:color-mix(in srgb, var(--dsw-alias-state-success-primary) 68%, var(--dsw-alias-label-secondary))}.LlSJ9q_span[data-timeline-span=message]{--trajectory-assistant-decoding-color:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 60%, var(--dsw-alias-state-error-secondary));--trajectory-assistant-ttft-color:color-mix(in srgb, var(--trajectory-assistant-decoding-color) 54%, var(--dsw-alias-bg-layer-2));background:var(--trajectory-assistant-decoding-color);opacity:1}.LlSJ9q_span[data-timeline-span=message][data-assistant-timing=true]{background:linear-gradient(to right, var(--trajectory-assistant-ttft-color) 0, var(--trajectory-assistant-ttft-color) var(--trajectory-assistant-ttft), var(--trajectory-assistant-decoding-color) var(--trajectory-assistant-ttft), var(--trajectory-assistant-decoding-color) 100%)}.LlSJ9q_span[data-timeline-span=tool],.LlSJ9q_span[data-timeline-span=subtool]{background:var(--dsw-alias-state-warn-label);opacity:1}.LlSJ9q_span[data-error=true]{background:var(--dsw-alias-state-error-primary)}.LlSJ9q_span[data-equal-duration=true]{width:8px;min-width:8px}.LlSJ9q_span[data-selected=false]{opacity:.2}.LlSJ9q_span[data-hovered=true]:not([data-current=true]){z-index:1;opacity:1;box-shadow:0 0 0 1px var(--dsw-alias-bg-layer-2), 0 0 0 2px color-mix(in srgb, var(--dsw-alias-state-business-primary) 80%, transparent)}.LlSJ9q_span[data-current=true]{z-index:1;opacity:1;box-shadow:0 0 0 1px var(--dsw-alias-bg-layer-2), 0 0 0 2px var(--dsw-alias-state-business-primary)}.LlSJ9q_span[data-search-match=false]{opacity:.14}.LlSJ9q_selection{z-index:1;top:0;bottom:0;left:var(--trajectory-selection-left);width:var(--trajectory-selection-width);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 12%, transparent);min-width:1px;box-shadow:-100vw 0 0 100vw color-mix(in srgb, var(--dsw-alias-bg-layer-1) 58%, transparent), 100vw 0 0 100vw color-mix(in srgb, var(--dsw-alias-bg-layer-1) 58%, transparent);pointer-events:none;position:absolute}.LlSJ9q_selectionEdges{z-index:4;top:0;bottom:0;left:var(--trajectory-selection-left);width:var(--trajectory-selection-width);pointer-events:none;min-width:1px;position:absolute}.LlSJ9q_hoverLine{z-index:4;top:0;bottom:0;left:clamp(0px, calc(var(--trajectory-hover-left) - 1px), calc(100% - 2px));background:var(--dsw-alias-state-business-primary);pointer-events:none;width:2px;position:absolute}.LlSJ9q_selectionEdges:before,.LlSJ9q_selectionEdges:after{background:var(--dsw-alias-state-business-primary);content:\"\";width:3px;position:absolute;top:0;bottom:0}.LlSJ9q_selectionEdges:before{left:0}.LlSJ9q_selectionEdges:after{right:0}.LlSJ9q_selectionEdges[data-dragging=true]:before,.LlSJ9q_selectionEdges[data-dragging=true]:after{width:2px}.LlSJ9q_selection[data-dragging=true]{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 18%, transparent)}";
		...
		var TrajectoryTimeline_module_css_default = {
			"earlierHistory": "LlSJ9q_earlierHistory",
			"empty": "LlSJ9q_empty",
			"hoverLine": "LlSJ9q_hoverLine",
			"labels": "LlSJ9q_labels",
			"lanes": "LlSJ9q_lanes",
			"plot": "LlSJ9q_plot",
			"root": "LlSJ9q_root",
			"selection": "LlSJ9q_selection",
			"selectionEdges": "LlSJ9q_selectionEdges",
			"span": "LlSJ9q_span",
			"track": "LlSJ9q_track",
			"turnBoundaries": "LlSJ9q_turnBoundaries",
			"turnBoundary": "LlSJ9q_turnBoundary"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/jack/java/dsh-java/frontend/packages/client/ui-trajectory/src/client/views.module.css.mjs
		const css = ".MsXQBa_root{--dsh-trajectory-toolbar-height:32px;box-sizing:border-box;width:100%;height:100%;min-height:0;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);flex-direction:column;display:flex;overflow:hidden}.MsXQBa_ledger{z-index:0;isolation:isolate;--dsh-trajectory-bottom-clearance:calc(var(--dsh-composer-height,152px) + 16px);flex:1;min-width:0;min-height:0;display:flex;position:relative;overflow:hidden}";
